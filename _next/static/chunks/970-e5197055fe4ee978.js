    ...
    [970], {
        7209: function (t, e, i) {
            var s = function () {
                ...
                r = "function" == typeof requestAnimationFrame ? requestAnimationFrame.bind(o) : function (t) {
            ...
            var g = function () {
                        ...
                        var t = function (t) {
                            ...
                            return function (t) {
                                ...
                                var s = u(t).getComputedStyle(t),
                                    ...
                                    h = d(s.width),
                                    l = d(s.height);
                                if ("border-box" === s.boxSizing && (Math.round(h + o) !== e && (h -= f(s, "left", "right") + o), Math.round(l + r) !== i && (l -= f(s, "top", "bottom") + r)), t !== u(t).document.documentElement) {
                                    var a = Math.round(h + o) - e,
                                        c = Math.round(l + r) - i;
                                    1 !== Math.abs(a) && (h -= a), 1 !== Math.abs(c) && (l -= c)
                                }
                ...
                _ = function (t, e) {
                    var i, s, n, o, r, h = (i = e.x, s = e.y, n = e.width, o = e.height, c(r = Object.create(("undefined" != typeof DOMRectReadOnly ? DOMRectReadOnly : Object).prototype), {
                        x: i,
                        y: s,
                        width: n,
                        height: o,
                ...
                b = function () {
                    function t(t, e, i) {
                        if (this.activeObservations_ = [], this.observations_ = new s, "function" != typeof t) throw TypeError("The callback provided as parameter 1 is not a function.");
                        this.callback_ = t, this.controller_ = e, this.callbackCtx_ = i
                    }
                    return t.prototype.observe = function (t) {
                        if (!arguments.length) throw TypeError("1 argument required, but only 0 present.");
                        if ("undefined" != typeof Element && Element instanceof Object) {
                            if (!(t instanceof u(t).Element)) throw TypeError('parameter 1 is not of type "Element".');
                ...
                constructor(t, {
                    ...
                    this.onTouchStart = t => {
                        ...
                        let {
                            clientX: e,
                            clientY: i
                        } = t.targetTouches ? t.targetTouches[0] : t, s = -(e - this.touchStart.x) * this.touchMultiplier, n = -(i - this.touchStart.y) * this.touchMultiplier;
                        this.touchStart.x = e, this.touchStart.y = i, this.lastDelta = {
                            x: s,
                            y: n
                        ...
                        this.normalizeWheel && (e = n(-100, e, 100), i = n(-100, i, 100)), e *= this.wheelMultiplier, i *= this.wheelMultiplier, this.emitter.emit("scroll", {
                            deltaX: e,
                            deltaY: i,
                            event: t
                        })
                        ...
                        x: null,
                        y: null
                    }, this.emitter = new h, this.element.addEventListener("wheel", this.onWheel, {
                        passive: !1
            ...
            class a {
                constructor({
                    ...
                    this.onVirtualScroll = ({
                        ...
                        if ((r = r.slice(0, r.indexOf(this.rootElement))).find(t => {
                                var e;
                                return (null == t.hasAttribute ? void 0 : t.hasAttribute("data-lenis-prevent")) || n && (null == t.hasAttribute ? void 0 : t.hasAttribute("data-lenis-prevent-touch")) || o && (null == t.hasAttribute ? void 0 : t.hasAttribute("data-lenis-prevent-wheel")) || (null == (e = t.classList) ? void 0 : e.contains("lenis"))
                            })) return;
                        if (this.isStopped || this.isLocked) return void i.preventDefault();
                        if (this.isSmooth = (this.options.smoothTouch || this.options.syncTouch) && n || this.options.smoothWheel && o, !this.isSmooth) return this.isScrolling = !1, void this.animate.stop();
                        i.preventDefault();
                        let h = e;
                        ...
                        a && (h = this.velocity * this.options.touchInertiaMultiplier), this.scrollTo(this.targetScroll + h, s({
                            programmatic: !1
                        }, l && {
                        ...
                        normalizeWheel: E,
                        autoResize: O
                    }, this.animate = new o, this.emitter = new h, this.dimensions = new r({
                        wrapper: t,
                        content: e,
                        autoResize: O
                ...
                scrollTo(t, {
                    ...
                    if (!this.isStopped && !this.isLocked || a) {
                        ...
                        if ("number" == typeof t) {
                            if (t += e, t = Math.round(t), this.options.infinite ? c && (this.targetScroll = this.animatedScroll = this.scroll) : t = n(0, t, this.limit), i) return this.animatedScroll = this.targetScroll = t, this.setScroll(this.scroll), this.reset(), void(null == l || l(this));
                            if (!c) {
