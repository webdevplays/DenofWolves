	...
	[535], {
		...
		4552: function (e, t, i) {
			...
			var s, n, a = i(9477),
				...
				r = i(8174),
				l = i(2001);
			(s = n || (n = {})).Image = "image", s.Video = "video", s.Model = "model", s.PointCloud = "pointcloud";
			class h {
						...
						"" !== t[0] && t.forEach(t => {
							...
							if (i[0].includes(".")) {
								let t = i[0].spsslit("."),
									...
									r = 1 / o;
								a.forEach((t, i) => {
									void 0 !== this.settings[s] && (0 === i ? this.channelsTimelines[e - 1].to(this.settings[s], {
										[n]: t,
										duration: 0
									}, 0) : this.channelsTimelines[e - 1].to(this.settings[s], {
										[n]: t,
										duration: r
									}, (i - 1) * r))
								})
								...
								let t = i[0],
									...
									a = 1 / (n - 1);
								s.forEach((i, s) => {
									void 0 !== this.settings[t] && (0 === s ? this.channelsTimelines[e - 1].to(this.settings, {
										[t]: i,
										duration: 0
				...
				getAssetType(e) {
					return e.includes("png") || e.includes("jpg") ? n.Image : e.includes("mp4") ? n.Video : e.includes("glb") ? n.Model : e.includes("ply") ? n.PointCloud : void 0
				}
				destroy() {
		...
		5535: function (e, t, i) {
			...
			class p {
				applySettingsFromJSON(e) {
					Object.keys(e).forEach(t => {
						void 0 !== this.defaultSettings[t] && (this.settings[t] = e[t])
					}), this.applySettings(), this.parseChannels()
				}
				getSettingsDiff() {
					let e = {};
					return Object.keys(this.settings).forEach(t => {
				...
				createUI() {
					...
					e.debug.isActive && (this.settingsFolder = this.settingsUI.pane.addFolder({
						...
						min: 0,
						max: 120
					}), this.settingsFolder.addBinding(this.settings, "horisontalPixelSmudgeStepUp", {
						min: 10,
						max: 2e3
					}), this.settingsFolder.addBinding(this.settings, "horisontalPixelSmudgeStepDown", {
						min: 10,
						max: 2e3
				...
				updateChannelTimeline(e, t) {
					this.blockIncomingChannels || (this.channelsTimelines[e].time(0), this.channelsTimelines[e].time(t + .01), this.applySettings(), this.currentChannelAmount[e] = t)
				}
				...
				setSaturation(e) {
					this.compositingPass.uniforms.hsvCorrection.value.z = 1 - .8 * (1 - e), this.compositingPass.uniforms.hsvCorrection.value.y = e
				}
				applySettings() {
					this.compositingPass.uniforms.globalStrength.value = this.settingsUI.shared.globalStrength, this.compositingPass.uniforms.verticalPixelSmudgeAmount.value = this.settings.verticalPixelSmudgeAmount, this.compositingPass.uniforms.verticalPixelSmudgeStepUp.value = this.settings.verticalPixelSmudgeStepUp, this.compositingPass.uniforms.verticalPixelSmudgeStepDown.value = this.settings.verticalPixelSmudgeStepDown, this.compositingPass.uniforms.horisontalPixelSmudgeAmount.value = this.settings.horisontalPixelSmudgeAmount, this.compositingPass.uniforms.horisontalPixelSmudgeStepUp.value = this.settings.horisontalPixelSmudgeStepUp, this.compositingPass.uniforms.horisontalPixelSmudgeStepDown.value = this.settings.horisontalPixelSmudgeStepDown, this.compositingPass.uniforms.asciiAmount.value = this.settings.asciiAmount, this.compositingPass.uniforms.asciiUvSize.value = this.settings.asciiUvSize, this.compositingPass.uniforms.posterizeColors.value = this.settings.posterizeColors, this.compositingPass.uniforms.posterizeGamma.value = this.settings.posterizeGamma, this.compositingPass.uniforms.invertAmount.value = this.settings.invertAmount, this.compositingPass.uniforms.scanlinesAmount.value = this.settings.scanlinesAmount
				}
				reset() {}
				render(e, t) {
					this.compositingPass.uniforms.time.value = e, this.compositingPass.uniforms.verticalPixelSmudgeAmount.value = this.settings.verticalPixelSmudgeAmount, this.compositingPass.uniforms.horisontalPixelSmudgeAmount.value = this.settings.horisontalPixelSmudgeAmount + this.extraGlitch * this.settings.randomGlitchHorisontalPixelSmudgeAmount, this.genericComposer.render(t), this.renderer.setRenderTarget(null)
				}
				setMask(e) {}
				resize(e, t) {
				...
				startGlitchTimeline() {
					this.glitchTimeline && this.glitchTimeline.kill(), this.glitchTimeline = v.ZP.timeline({
						duration: 7,
						repeat: -1
					}), this.glitchTimeline.call(() => {
						this.settings.horisontalPixelSmudgeStepUp = 10 + 4 * Math.random(), this.settings.horisontalPixelSmudgeStepDown = 14 + 5 * Math.random(), this.settings.randomGlitchHorisontalPixelSmudgeAmount = 1 + 2 * Math.random(), this.compositingPass.uniforms.horisontalPixelSmudgeStepUp.value = this.settings.horisontalPixelSmudgeStepUp, this.compositingPass.uniforms.horisontalPixelSmudgeStepDown.value = this.settings.horisontalPixelSmudgeStepDown
					}, 0), this.glitchTimeline.to(this, {
						extraGlitch: 1,
						duration: 0
				...
				stopGlitchTimeline() {
					this.settings.randomGlitchHorisontalPixelSmudgeAmount = 0, this.settings.verticalPixelSmudgeStepUp = 10, this.settings.verticalPixelSmudgeStepDown = 53, this.compositingPass.uniforms.verticalPixelSmudgeStepUp.value = this.settings.verticalPixelSmudgeStepUp, this.compositingPass.uniforms.verticalPixelSmudgeStepDown.value = this.settings.verticalPixelSmudgeStepDown, this.glitchTimeline && this.glitchTimeline.kill(), this.extraGlitch = 0
				}
				setScrollAmount(e) {
					this.compositingPass.uniforms.scrollAmount.value = e > .01 ? 1 : 0
				}
				dispose() {
					f.h.getState().api.trigger.remove(this.onTrigger), this.glitchTimeline && this.glitchTimeline.kill(), this.settingsFolder && (this.settingsFolder.children.forEach(e => {
						e.dispose()
					}), this.settingsFolder.dispose())
				}
				constructor(e) {
					...
					}, this.onTrigger = e => {}, this.settingsUI = new m.Z, this.renderer = e, f.h.getState().api;
					for (let e = 0; e < 4; e++) this.channelsTimelines.push(v.ZP.timeline({
						paused: !0,
						duration: 1
					}));
					this.renderTargetGeneric = new l.dd2(window.innerWidth, window.innerHeight, {
						minFilter: l.wem,
						magFilter: l.wem,
						format: l.wk1,
						stencilBuffer: !0,
						colorSpace: l.GUF,
						type: l.cLu
					}), this.genericComposer = new h.x(this.renderer, this.renderTargetGeneric), this.genericComposer.setPixelRatio(1), this.renderPass = new c.C(this.scene, this.camera, void 0, void 0, 1), this.renderPass.clear = !0, this.renderPass.needsSwap = !1, this.compositingPass = new d.T(u);
					let t = new g.default().assetManager.getTexture("ascii");
					t && (t.wrapS = t.wrapT = l.rpg, t.colorSpace = l.KI_), this.compositingPass.uniforms.tAscii.value = t, this.compositingPass.renderToScreen = !1, this.genericComposer.addPass(this.renderPass), this.genericComposer.addPass(this.compositingPass), this.defaultSettings = {
						rgbWaveTimescale: 0,
						rgbWaveAmount: 0,
						...
						channel3: "",
						channel4: ""
					}, this.settings = JSON.parse(JSON.stringify(this.defaultSettings)), this.settingsUI.onSettingsUpdated.add(e => {
						e.type === m.a.Post && (this.applySettingsFromJSON(e.settings), this.applySettings())
					}), this.createUI(), this.parseChannels(), f.h.getState().api.trigger.add(this.onTrigger)
				}
			}
			var x = i(7836),
				S = i(4552);
			...
			class T extends S.Z {
				...
				loadMesh() {
					y.load("/models/" + this.settings.currentPlaneMeshName, e => {
						...
						let i = t.geometry.getAttribute("position"),
							s = [],
							n = new l.Ilk;
						for (let e = 0; e < i.count; e += 4) n.setHex(16777215 * Math.random()), s.push(n.r, n.g, n.b), s.push(n.r, n.g, n.b), s.push(n.r, n.g, n.b), s.push(n.r, n.g, n.b);
						t.geometry.setAttribute("randomColor", new l.a$l(s, 3)), t.geometry.applyMatrix4(new l.yGw().makeTranslation(new l.Pa4(0, 0, .01))), t.rotation.x = .5 * Math.PI, t.scale.setScalar(2), t.renderOrder = 100, t.material = this.planeMaterial, this.applySettings(), this.group.add(t)
					}, () => {}, e => {
				...
				constructor() {
					super({
						...
						channel3: "",
						channel4: ""
					}, this.settingsUI = new m.Z, this.settingsUI.onSharedUpdated.add(() => {
						...
						uniforms: {
							...
							defaultColor: {
								value: new l.Ilk(this.settings.defaultColor)
							},
							sourceAspect: {
								value: 1
							},
							resolution: {
								value: new l.FM8(100, 100)
							},
							isBloomRender: {
								value: 0
							},
			...
			class U extends S.Z {
				createUI() {
					super.createUI(), this.isDebug && (this.settingsFolder.addBinding(this.settings, "display"), this.settingsFolder.addBinding(this.settings, "currentPlaneMeshName", {
						...
						min: 0,
						max: 1
					}), this.settingsFolder.addBinding(this.settings, "rgbWaveTimescale", {
						min: 0,
						max: 1
						...
						min: 0,
						max: 1
					}), this.settingsFolder.addBinding(this.settings, "whiteNoiseAmount", {
						min: 0,
						max: 2
				...
				loadMesh() {
					P.load("/models/" + this.settings.currentPlaneMeshName, e => {
						let t = e.scene.children[0];
						this.baseMesh && (this.baseMesh.geometry.dispose(), this.group.remove(this.baseMesh)), this.baseMesh = t;
						let i = t.geometry.getAttribute("position"),
							s = [],
							n = new l.Ilk;
						for (let e = 0; e < i.count; e += 4) n.setHex(16777215 * Math.random()), s.push(n.r, n.g, n.b), s.push(n.r, n.g, n.b), s.push(n.r, n.g, n.b), s.push(n.r, n.g, n.b);
						t.geometry.setAttribute("randomColor", new l.a$l(s, 3)), t.geometry.applyMatrix4(new l.yGw().makeTranslation(new l.Pa4(0, 0, .01))), t.rotation.x = .5 * Math.PI, t.scale.setScalar(2), t.material = this.planeMaterial, this.applySettings(), this.group.add(t)
					}, () => {}, e => {
						console.warn("can' find model", e)
					})
				}
				...
				constructor() {
					super({
						name: "Landingnoise",
						settingsType: m.a.LandingNoise
					}), this.type = o.Image, this.applySettings = () => {
						this.baseMesh && (this.baseMesh.visible = this.settings.display, void 0 !== this.settings.displayOverride && (this.baseMesh.visible = this.settings.displayOverride)), this.lookAtCamera = this.settings.lookAtCamera, this.planeMaterial.uniforms.globalStrength.value = this.settingsUI.shared.globalStrength, this.planeMaterial.uniforms.sourceThreshold.value = this.settings.planeThreshold, this.planeMaterial.uniforms.shuffleGridSize.value.copy(this.settings.shuffleGridSize), this.planeMaterial.uniforms.shuffleAmount.value = this.settings.shuffleAmount, this.planeMaterial.uniforms.shuffleKeepInCenter.value = this.settings.shuffleKeepInCenter ? 1 : 0, this.planeMaterial.uniforms.quadExtraNoise.value = this.settings.quadExtraNoise, this.planeMaterial.uniforms.quadRandomColor.value = this.settings.quadRandomColor, this.planeMaterial.uniforms.blockNoiseTimescale.value = this.settings.blockNoiseTimescale, this.planeMaterial.uniforms.blockNoiseAmount.value = this.settings.blockNoiseAmount, this.planeMaterial.uniforms.rgbWaveTimescale.value = this.settings.rgbWaveTimescale, this.planeMaterial.uniforms.rgbWaveAmount.value = this.settings.rgbWaveAmount, this.planeMaterial.uniforms.shakeTimescale.value = this.settings.shakeTimescale, this.planeMaterial.uniforms.shakeAmount.value = this.settings.shakeAmount, this.planeMaterial.uniforms.whiteNoiseAmount.value = this.settings.whiteNoiseAmount, this.planeMaterial.uniforms.linesAmount.value = this.settings.linesAmount, this.planeMaterial.uniforms.verticalPixelSmudgeAmount.value = this.settings.verticalPixelSmudgeAmount, this.planeMaterial.uniforms.quadOffset.value.copy(this.settings.quadOffset), this.planeMaterial.uniforms.defaultColor.value.set(this.settings.defaultColor)
					}, this.lookAtCamera = !0, this.defaultSettings = {
						display: !0,
						solo: !1,
						lookAtCamera: !0,
			...
			class z extends S.Z {
				...
				createParticles() {
					let e = new l.Pa4,
						t = [new l.Pa4(-.3, .1, 0), new l.Pa4(-.2, .4, 0), new l.Pa4(-.1, .1, 0), new l.Pa4(0, 0, 0), new l.Pa4(.05, -.1, 0), new l.Pa4(.1, .1, 0), new l.Pa4(.2, -.1, 0), new l.Pa4(.3, 0, 0)],
						i = t.length,
						s = new l.lb7(new Float32Array(3 * i), 3, !1, 1),
						n = new l.lb7(new Float32Array(3 * i), 3, !1, 1),
						a = new l.lb7(new Float32Array(2 * i), 2, !1, 2);
					for (let o = 0; o < i; o++) {
						e.copy(t[o]), e.x *= 5, e.y *= 5, s.setXYZ(o, e.x, e.y, e.z - .2);
						let i = M.set(0);
						n.setXYZ(o, i.r, i.g, i.b), a.setXY(o, Math.random(), Math.random())
					}
					let o = new l._12(.2, .4, 1, 1),
						r = new l.L5s().copy(o);
					r.setAttribute("particlePosition", s), r.setAttribute("particleColor", n), r.setAttribute("particleRandom", a);
				...
				constructor() {
					super({
						name: "Landing quads",
						settingsType: m.a.LandingQuads
					}), this.group = new l.ZAu, this.particleMeshes = [], this.applySettings = () => {
						this.particlesMaterialFront && (this.particlesMaterialFront.uniforms.displaceAmount.value = this.settings.displaceAmount, this.particlesMaterialFront.uniforms.reduce.value = this.settings.reduce)
						...
						uniforms: {
							...
							particleScale: {
								value: new l.Pa4(6, 6, 6)
							},
							displaceAmount: {
								value: this.settings.displaceAmount
							},
							reduce: {
								value: this.settings.reduce
							}
						},
						blending: l.bdR,
						...
						side: l.ehD
					}), this.createUI(), this.applySettings(), this.createParticles()
				}
			}
			let k = "/models/",
				I = "/images/",
			...
			class q extends A.Q {
				async init() {
					var e;
					await this.load();
					let t = this.experience.assetManager.getTexture("landing-pattern.png");
					return t && (t.minFilter = t.magFilter = l.TyD, t.wrapS = t.wrapT = l.rpg), this.patternPlane.setSource("landing-pattern.png"), this.settingsUI = new m.Z, this.experience.debug.isActive && (this.initSettingsUI(), this.applySettings(), this.createAllModules()), this.settingsUI.onSettingsUpdated.add(e => {
						if (e.type === m.a.All) Object.keys(e.settings).forEach(t => {
							void 0 !== this.defaultSettings[t] && (this.settings[t] = e.settings[t])
						}), this.initSettingsUI(), this.applySettings();
						else {
							let t = N[e.type];
					...
					}), this.settingsUI.setPreset("landingpage", !0), null === (e = this.settingsFolder) || void 0 === e || e.refresh(), await this.loadAsset("logo-v1.png"), w.Z.emit(w.F.WEBGL_ASSET_LOADED, {
						assetUrl: ""
					}), Promise.resolve()
				}
				transitionIn() {
				...
				startIntroGlitch() {
					let e = {
						...
						t = {
							globalTimescale: .91,
							post: {
								verticalPixelSmudgeAmount: 5.21
							},
							plane: {
								planeThreshold: 0
							}
					...
					let s = v.ZP.timeline({
						onUpdate: () => {
							this.settingsUI.setGlobalStrength(e.globalTimescale), this.settingsUI.applyPresetSettings(e)
						},
						onComplete: () => {
							this.isRunningIntro = !1, this.postEffectManager.startGlitchTimeline()
						}
					});
					s.to(e.post, {
						duration: .2,
						...
						duration: .2,
						globalTimescale: t.globalTimescale
					}, .2), s.to(e.post, {
						duration: .2,
						verticalPixelSmudgeAmount: i.post.verticalPixelSmudgeAmount
					}, .4), s.to(e.plane, {
						duration: .1,
						planeThreshold: i.plane.planeThreshold
					}, .4), this.timeline = s
				}
				afterTransitionOut() {
				...
				exitFullGlitch() {
					this.drawImageScaled(!1), this.canvasTexture.needsUpdate = !0, this.settingsUI.applyPresetSettings({
						globalTimescale: .91,
						post: {
							verticalPixelSmudgeAmount: 0,
							verticalPixelSmudgeStepUp: 53.14,
				...
				gotoFullGlitch() {
					...
					}, .2), i.to(e.plane.quadOffset, {
						duration: .2,
						x: t.plane.quadOffset.x,
						z: t.plane.quadOffset.z
					}, .2), i.to(e.landingquads, {
						duration: .1,
						reduce: 0
					}, .2), i.to(e.landingquads, {
						duration: .5,
				...
				createAllModules() {
					D.forEach(e => {
						let t = new e;
						t.settingsType === m.a.BackgroundQuads || t.settingsType === m.a.SurfaceAscii ? this.camera.add(t.group) : this.scene.add(t.group), this.activeEffects.push(t)
					})
				}
				getAllEffects() {
				...
				createBackground() {
					this.bgMaterial = new l.jyz({
						uniforms: {
							color1: {
								value: new l.Ilk(this.settings.color1)
							},
							color2: {
								value: new l.Ilk(this.settings.color2)
							}
						},
						vertexShader: "precision highp float;\nprecision mediump int;\n#define GLSLIFY 1\n\nvarying vec2 vUv;\n\nvoid main()	{\n  vUv = uv;\n  gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );\n}",
				...
				async loadAsset(e) {
					"" !== e && void 0 !== e && (this.currentAssetUrl = e, e.includes(".jpg") || e.includes(".png") ? await this.loadImage(e) : e.includes(".mp4") ? await this.loadVideo(e) : (e.includes(".glb") || e.includes(".gltf") || e.includes(".ply")) && await this.loadModel(e))
				}
				async loadImage(e) {
					...
					return e.startsWith("blob") && (t = e), new Promise((e, i) => {
						this.experience.assetManager.loadManifest([{
							...
							i && (this.currentImageAsset = i.source.data, this.drawImageScaled(!1), this.canvasTexture = new l.ROQ(this.canvas), this.canvasTexture.colorSpace = l.KI_, this.experience.assetManager.removeTexture(t), this.experience.assetManager.addTexture(t, this.canvasTexture, "streamnode-content"), this.activeEffects.forEach(e => {
				...
				async loadVideo(e) {
					...
					return e.startsWith("blob") && (t = e), new Promise((e, i) => {
						this.experience.assetManager.loadManifest([{
							...
							if (i) {
								let e = i.source.data.videoWidth / i.source.data.videoHeight;
				...
				async loadModel(e) {
					...
					return e.startsWith("blob") && (t = e), this.experience.assetManager.unloadNamespace("streamnode-content"), new Promise((e, i) => {
						this.experience.assetManager.loadManifest([{
							key: t,
							url: t
						}], "streamnode-content").then(() => {
				...
				update(e, t) {
					...
					let i = l.M8C.clamp(this.experience.sizes.width / 2500, 0, .9);
					l.M8C.clamp(this.experience.sizes.height / 700, 0, .9), this.camera.position.z = 3 - l.M8C.mapLinear(i, .5, 1, 0, 1.2), this.camera.position.y = 0 + l.M8C.mapLinear(i, .5, 1, 0, .3), this.cameraTarget.y = this.camera.position.y, this.camera.lookAt(this.cameraTarget), this.time = e, this.patternPlane.update(this.time * this.settingsUI.shared.globalTimescale), this.activeEffects.forEach(e => {
				...
				dispose() {
					this.unsubscribeToStoreFunction && this.unsubscribeToStoreFunction(), this.timeline && (this.timeline.kill(), this.timeline = void 0), f.h.getState().api.trigger.remove(this.onTrigger), this.experience.sizes.clearElementReference(), this.experience.sizes.off("resize", this.onResizeHandler), super.dispose(), this.isDestroyed = !0, this.postEffectManager.dispose && this.postEffectManager.dispose(), this.settingsFolder && (this.settingsFolder.children.forEach(e => {
						e.dispose()
				...
				constructor(e) {
					var t;
					super(e), t = this, this.cameraTarget = new l.Pa4, this.isDestroyed = !1, this.time = 0, this.activeEffects = [], this.isRunningIntro = !0, this.currentColorMode = -1, this.landingGlitchMode = f.dl.NotSet, this.onStoreStateChanged = () => {
						let e = f.h.getState();
						if (e.landingGlitchMode !== this.landingGlitchMode) {
							if (this.isRunningIntro) return;
							e.landingGlitchMode === f.dl.Hero ? this.postEffectManager.startGlitchTimeline() : this.postEffectManager.stopGlitchTimeline(), e.landingGlitchMode === f.dl.Full ? this.gotoFullGlitch() : this.landingGlitchMode === f.dl.Full && this.exitFullGlitch(), this.landingGlitchMode = e.landingGlitchMode
						}
						if (e.landingColorMode !== this.currentColorMode) {
							...
							1 === this.currentColorMode ? this.postEffectManager.setSaturation(0) : this.postEffectManager.setSaturation(1);
							...
							v.ZP.to(t, {
								...
								duration: .5,
								onUpdate: () => {
									this.bgMaterial.uniforms.color1.value.copy(_.lerpColors(i, s, t.value)), this.bgMaterial.uniforms.color2.value.copy(_.lerpColors(n, a, t.value)), 1 === this.currentColorMode ? this.patternPlane.planeMaterial.uniforms.opacity.value = .3 * t.value : this.patternPlane.planeMaterial.uniforms.opacity.value = 1 - .2 * t.value
								}
							})
						}
					}, this.onTrigger = e => {
						...
						let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
							i = t.canvas,
							s = Math.min(i.width / t.currentImageAsset.width, i.height / t.currentImageAsset.height),
							n = (i.width - t.currentImageAsset.width * s) / 2,
							a = (i.height - t.currentImageAsset.height * s) / 2;
						t.ctx.clearRect(0, 0, i.width, i.height), t.ctx.fillStyle = "#666666", e && t.ctx.fillRect(0, 0, i.width, i.height), t.ctx.drawImage(t.currentImageAsset, 0, 0, t.currentImageAsset.width, t.currentImageAsset.height, n, a, t.currentImageAsset.width * s, t.currentImageAsset.height * s)
					}, this.onResizeHandler = () => {
						let e = Math.ceil(this.experience.sizes.width),
							t = Math.ceil(this.experience.sizes.height);
						this.camera.aspect = e / t, this.camera.updateProjectionMatrix(), r.Z.getRenderer().setSize(e, t), this.postEffectManager.resize(e, t), this.activeEffects.forEach(e => {
					...
					}, this.canvas = document.createElement("canvas"), this.ctx = this.canvas.getContext("2d"), this.canvas.width = 2048, this.canvas.height = 2048, this.camera = new l.cPb(40, window.innerWidth / window.innerHeight, .1, 300), this.camera.position.z = 4, this.camera.position.y = .1, this.cameraTarget.y = .1, this.scene = new l.xsS, this.scene = new l.xsS, this.scene.background = new l.Ilk(0), this.scene.add(this.camera), this.camera.lookAt(this.cameraTarget), this.experience.sizes.registerElement(r.Z.getRenderer().domElement.parentElement), this.experience.sizes.on("resize", this.onResizeHandler), this.defaultSettings = {
						animateCamera: !0,
						color1: E[0][0],
						color2: E[0][1]
					}, this.settings = JSON.parse(JSON.stringify(this.defaultSettings)), this.createBackground(), this.postEffectManager = new p(r.Z.getRenderer()), this.postEffectManager.setSceneAndCamera(this.scene, this.camera), this.patternPlane = new U, this.patternPlane.group.position.z = -.1, this.patternPlane.planeMaterial.uniforms.opacity.value = 1, this.scene.add(this.patternPlane.group), this.landingQuads = new z, this.landingQuads.group.position.z = .5, this.scene.add(this.landingQuads.group), this.unsubscribeToStoreFunction = f.h.subscribe(this.onStoreStateChanged), f.h.getState().api.trigger.add(this.onTrigger), this.onResizeHandler()
				}
			}
		},
		0: function (e, t, i) {
			...
			class o {
				...
				constructor(e) {
					this.isLoaded = !1, this.config = e, this.experience = new s.default
				}
			}
		},
		6090: function (e, t, i) {
			...
			var s, n, a = i(29),
				...
				r = i(8174);
			let l = "default";
			(s = n || (n = {})).All = "all", s.None = "none", s.Plane = "plane", s.Ascii = "ascii", s.Columns = "columns", s.Stream = "stream", s.Post = "post", s.Grid = "grid", s.PointCloud = "point-cloud", s.Lines = "lines", s.SurfaceQuads = "surface-quads", s.BackgroundQuads = "background-quads", s.SurfaceAscii = "surface-ascii", s.LandingNoise = "landing-noise", s.LandingQuads = "landingquads";
			let h = null;
			class c {
				reset() {
				...
				constructor() {
					if (this.shared = {
							globalStrength: 1,
							globalTimescale: 1
						}, this.onSharedUpdated = new a.Z, this.onSettingsUpdated = new a.Z, this.onSettingsReset = new a.Z, this.onSettingsSolo = new a.Z, h) return h;
					h = this;
					let e = new r.default;
			...
			class r {
				constructor(e, t) {
					if (this.renderer = e, this._pixelRatio = e.getPixelRatio(), void 0 === t) {
						...
						this._width = i.width, this._height = i.height, (t = new s.dd2(this._width * this._pixelRatio, this._height * this._pixelRatio, {
							type: s.cLu
						})).texture.name = "EffectComposer.rt1"
					} else this._width = t.width, this._height = t.height;
					this.renderTarget1 = t, this.renderTarget2 = t.clone(), this.renderTarget2.texture.name = "EffectComposer.rt2", this.writeBuffer = this.renderTarget1, this.readBuffer = this.renderTarget2, this.renderToScreen = !0, this.passes = [], this.copyPass = new a.T(n), this.copyPass.material.blending = s.jFi, this.clock = new s.SUY
				}
				swapBuffers() {
				...
				render(e) {
					...
					for (let t = 0, s = this.passes.length; t < s; t++) {
						let s = this.passes[t];
						if (!1 !== s.enabled) {
							if (s.renderToScreen = this.renderToScreen && this.isLastEnabledPass(t), s.render(this.renderer, this.writeBuffer, this.readBuffer, e, i), s.needsSwap) {
								if (i) {
							...
							void 0 !== o.F && (s instanceof o.F ? i = !0 : s instanceof o.M && (i = !1))
						}
					}
				...
				setSize(e, t) {
					...
					for (let e = 0; e < this.passes.length; e++) this.passes[e].setSize(i, s)
				}
				setPixelRatio(e) {
		...
		4604: function (e, t, i) {
			...
			class n extends s.w {
				...
				render(e, t, i) {
					...
					let a = e.getContext(),
						o = e.state;
					o.buffers.color.setMask(!1), o.buffers.depth.setMask(!1), o.buffers.color.setLocked(!0), o.buffers.depth.setLocked(!0), this.inverse ? (s = 0, n = 1) : (s = 1, n = 0), o.buffers.stencil.setTest(!0), o.buffers.stencil.setOp(a.REPLACE, a.REPLACE, a.REPLACE), o.buffers.stencil.setFunc(a.ALWAYS, s, 4294967295), o.buffers.stencil.setClear(n), o.buffers.stencil.setLocked(!0), e.setRenderTarget(i), this.clear && e.clear(), e.render(this.scene, this.camera), e.setRenderTarget(t), this.clear && e.clear(), e.render(this.scene, this.camera), o.buffers.color.setLocked(!1), o.buffers.depth.setLocked(!1), o.buffers.color.setMask(!0), o.buffers.depth.setMask(!0), o.buffers.stencil.setLocked(!1), o.buffers.stencil.setFunc(a.EQUAL, 1, 4294967295), o.buffers.stencil.setOp(a.KEEP, a.KEEP, a.KEEP), o.buffers.stencil.setLocked(!0)
				}
			}
			class a extends s.w {
				constructor() {
		...
		8304: function (e, t, i) {
			...
			let a = new s.iKG(-1, 1, 1, -1, 0, 1),
				o = new s.u9r;
			o.setAttribute("position", new s.a$l([-1, 3, 0, -1, -1, 0, 3, -1, 0], 3)), o.setAttribute("uv", new s.a$l([0, 2, 0, 0, 2, 0], 2));
			class r {
				constructor(e) {
		...
		4458: function (e, t, i) {
			...
			class a extends n.w {
				constructor(e, t, i = null, n = null, a = null) {
					super(), this.scene = e, this.camera = t, this.overrideMaterial = i, this.clearColor = n, this.clearAlpha = a, this.clear = !0, this.clearDepth = !1, this.needsSwap = !1, this._oldClearColor = new s.Ilk
				}
				render(e, t, i) {
					let s, n;
					let a = e.autoClear;
					e.autoClear = !1, null !== this.overrideMaterial && (n = this.scene.overrideMaterial, this.scene.overrideMaterial = this.overrideMaterial), null !== this.clearColor && (e.getClearColor(this._oldClearColor), e.setClearColor(this.clearColor)), null !== this.clearAlpha && (s = e.getClearAlpha(), e.setClearAlpha(this.clearAlpha)), !0 == this.clearDepth && e.clearDepth(), e.setRenderTarget(this.renderToScreen ? null : i), !0 === this.clear && e.clear(e.autoClearColor, e.autoClearDepth, e.autoClearStencil), e.render(this.scene, this.camera), null !== this.clearColor && e.setClearColor(this._oldClearColor), null !== this.clearAlpha && e.setClearAlpha(s), null !== this.overrideMaterial && (this.scene.overrideMaterial = n), e.autoClear = a
				}
			}
		},
		7531: function (e, t, i) {
			...
			class a extends n.w {
				constructor(e, t) {
					super(), this.textureID = void 0 !== t ? t : "tDiffuse", e instanceof s.jyz ? (this.uniforms = e.uniforms, this.material = e) : e && (this.uniforms = s.rDY.clone(e.uniforms), this.material = new s.jyz({
