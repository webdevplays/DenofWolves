                ...
                var e = {
                        4567: function (e, t, i) {
                            ...
                            let n = i(9042),
                                ...
                                c = i(4725),
                                d = i(3656),
                                _ = t.AccessibilityManager = class extends h.Disposable {
                                    constructor(e, t) {
                                        ...
                                        if (this._topBoundaryFocusListener = e => this._handleBoundaryFocus(e, 0), this._bottomBoundaryFocusListener = e => this._handleBoundaryFocus(e, 1), this._rowElements[0].addEventListener("focus", this._topBoundaryFocusListener), this._rowElements[this._rowElements.length - 1].addEventListener("focus", this._bottomBoundaryFocusListener), this._refreshRowsDimensions(), this._accessibilityContainer.appendChild(this._rowContainer), this._liveRegion = document.createElement("div"), this._liveRegion.classList.add("live-region"), this._liveRegion.setAttribute("aria-live", "assertive"), this._accessibilityContainer.appendChild(this._liveRegion), this._liveRegionDebouncer = this.register(new a.TimeBasedDebouncer(this._renderRows.bind(this))), !this._terminal.element) throw Error("Cannot enable accessibility before Terminal.open");
                                    ...
                                    _renderRows(e, t) {
                                        let i = this._terminal.buffer,
                                            s = i.lines.length.toString();
                                        for (let r = e; r <= t; r++) {
                                            let e = i.translateBufferLineToString(i.ydisp + r, !0),
                                    ...
                                    _handleBoundaryFocus(e, t) {
                                        ...
                                        if (r.getAttribute("aria-posinset") !== (0 === t ? "1" : `${this._terminal.buffer.lines.length}`) && e.relatedTarget === n) {
                                            if (0 === t ? (i = r, s = this._rowElements.pop(), this._rowContainer.removeChild(s)) : (i = this._rowElements.shift(), s = r, this._rowContainer.removeChild(i)), i.removeEventListener("focus", this._topBoundaryFocusListener), s.removeEventListener("focus", this._bottomBoundaryFocusListener), 0 === t) {
                            ...
                            t.AccessibilityManager = s([r(1, c.IRenderService)], _)
                        },
                        3614: (e, t) => {
                            function i(e) {
                                return e.replace(/\r?\n/g, "\r")
                        ...
                        6465: function (e, t, i) {
                            ...
                            let n = i(3656),
                                ...
                                a = i(844),
                                h = i(2585),
                                l = t.Linkifier2 = class extends a.Disposable {
                                    get currentLink() {
                                    ...
                                    registerLinkProvider(e) {
                                        return this._linkProviders.push(e), {
                                            dispose: () => {
                                                let t = this._linkProviders.indexOf(e); - 1 !== t && this._linkProviders.splice(t, 1)
                                            }
                                        }
                                    }
                                    attachToDom(e, t, i) {
                                    ...
                                    _askForLink(e, t) {
                                        ...
                                        let r = !1;
                                        for (let [i, n] of this._linkProviders.entries()) t ? (null === (s = this._activeProviderReplies) || void 0 === s ? void 0 : s.get(i)) && (r = this._checkLinkProviderResult(i, e, r)) : n.provideLinks(e.y, t => {
                                            var s, n;
                                            if (this._isMouseOut) return;
                                            let o = null == t ? void 0 : t.map(e => ({
                                                link: e
                                            }));
                                    ...
                                    _checkLinkProviderResult(e, t, i) {
                                        ...
                                        if (this._activeProviderReplies.size === this._linkProviders.length && !i)
                                            for (let e = 0; e < this._activeProviderReplies.size; e++) {
                                                let r = null === (s = this._activeProviderReplies.get(e)) || void 0 === s ? void 0 : s.find(e => this._linkAtPosition(e.link, t));
                                                if (r) {
                                    ...
                                    _handleNewLink(e) {
                                        ...
                                        t && this._linkAtPosition(e.link, t) && (this._currentLink = e, this._currentLink.state = {
                                            ...
                                            let t = 0 === e.start ? 0 : e.start + 1 + this._bufferService.buffer.ydisp,
                                    ...
                                    _linkAtPosition(e, t) {
                                        let i = e.range.start.y * this._bufferService.cols + e.range.start.x,
                            ...
                            t.Linkifier2 = s([r(0, h.IBufferService)], l)
                        },
                        9042: (e, t) => {
                            Object.defineProperty(t, "__esModule", {
                                value: !0
                                ...
                                a = t.OscLinkProvider = class {
                                    ...
                                    provideLinks(e, t) {
                                        ...
                                        let r = [],
                                            ...
                                            a = new n.CellData,
                                            h = s.getTrimmedLength(),
                                            l = -1,
                                            c = -1,
                                            d = !1;
                                        for (let t = 0; t < h; t++)
                                            if (-1 !== c || s.hasContent(t)) {
                                                if (s.loadCell(t, a), a.hasExtendedAttrs() && a.extended.urlId) {
                                                    if (-1 === c) {
                                                        c = t, l = a.extended.urlId;
                                                        continue
                                                    }
                                                    d = a.extended.urlId !== l
                                                } else -1 !== c && (d = !0);
                                                if (d || -1 !== c && t === h - 1) {
                                                    let s = null === (i = this._oscLinkService.getLinkData(l)) || void 0 === i ? void 0 : i.uri;
                                                    if (s) {
                                                        let i = {
                                                                start: {
                                                                    x: c + 1,
                                                        ...
                                                        n || r.push({
                                                            text: s,
                                                            range: i,
                                                            activate: (e, t) => o ? o.activate(e, t, i) : function (e, t) {
...
WARNING: This link could potentially be dangerous`)) {
                                                    ...
                                                    d = !1, a.hasExtendedAttrs() && a.extended.urlId ? (c = t, l = a.extended.urlId) : (c = -1, l = -1)
                                                }
                                            } t(r)
                                    }
                                };
                            t.OscLinkProvider = s([r(0, o.IBufferService), r(1, o.IOptionsService), r(2, o.IOscLinkService)], a)
                        },
                        6193: (e, t) => {
                            Object.defineProperty(t, "__esModule", {
                                value: !0
                        ...
                        3236: (e, t, i) => {
                            ...
                            class P extends y.CoreTerminal {
                                ...
                                _handleColorEvent(e) {
                                    if (this._themeService)
                                        for (let t of e) {
                                            ...
                                            switch (t.type) {
                                                case 0:
                                                    let s = b.color.toColorRGB("ansi" === e ? this._themeService.colors.ansi[t.index] : this._themeService.colors[e]);
                                                    this.coreService.triggerDataEvent(`${L.C0.ESC}]${i};${(0,R.toRgbString)(s)}${L.C1_ESCAPED.ST}`);
                                                    break;
                                                case 1:
                                ...
                                _handleTextAreaFocus(e) {
                                    this.coreService.decPrivateModes.sendFocus && this.coreService.triggerDataEvent(L.C0.ESC + "[I"), this.updateCursorStyle(e), this.element.classList.add("focus"), this._showCursor(), this._onFocus.fire()
                                }
                                blur() {
                                    var e;
                                ...
                                _syncTextArea() {
                                    ...
                                    if (!t) return;
                                    let i = Math.min(this.buffer.x, this.cols - 1),
                                ...
                                _initGlobal() {
                                    ...
                                    let e = e => (0, s.handlePasteEvent)(e, this.textarea, this.coreService, this.optionsService);
                                ...
                                open(e) {
                                    ...
                                    let i = O.createDocumentFragment();
                                ...
                                bindMouse() {
                                    ...
                                    function i(t) {
                                        let i, s;
                                        let r = e._mouseService.getMouseReportCoords(t, e.screenElement);
                                        if (!r) return !1;
                                        switch (t.overrideType || t.type) {
                                            case "mousemove":
                                                s = 32, void 0 === t.buttons ? (i = 3, void 0 !== t.button && (i = t.button < 3 ? t.button : 3)) : i = 1 & t.buttons ? 0 : 4 & t.buttons ? 1 : 2 & t.buttons ? 2 : 3;
                                                break;
                                            case "mouseup":
                                                s = 0, i = t.button < 3 ? t.button : 3;
                                                break;
                                            case "mousedown":
                                                s = 1, i = t.button < 3 ? t.button : 3;
                                                break;
                                            case "wheel":
                                                if (0 === e.viewport.getLinesScrolled(t)) return !1;
                                                s = t.deltaY < 0 ? 0 : 1, i = 4;
                                                break;
                                            default:
                                                return !1
                                        }
                                        return !(void 0 === s || void 0 === i || i > 4) && e.coreMouseService.triggerMouseEvent({
                                            col: r.col,
                                            row: r.row,
                                            x: r.x,
                                            y: r.y,
                                    ...
                                    this.register(this.coreMouseService.onProtocolChange(e => {
                                        ...
                                        if (!s.wheel) {
                                            if (!this.buffer.hasScrollback) {
                                                ...
                                                if (0 === t) return;
                                                let i = L.C0.ESC + (this.coreService.decPrivateModes.applicationCursorKeys ? "O" : "[") + (e.deltaY < 0 ? "A" : "B"),
                                                    s = "";
                                ...
                                _keyUp(e) {
                                    this._keyDownSeen = !1, this._customKeyEventHandler && !1 === this._customKeyEventHandler(e) || (16 === e.keyCode || 17 === e.keyCode || 18 === e.keyCode || this.focus(), this.updateCursorStyle(e), this._keyPressHandled = !1)
                                }
                                _keyPress(e) {
                                    let t;
                                    if (this._keyPressHandled = !1, this._keyDownHandled || this._customKeyEventHandler && !1 === this._customKeyEventHandler(e)) return !1;
                                ...
                                reset() {
                                    ...
                                    let i = this._customKeyEventHandler;
                                ...
                                _reportFocus() {
                                    var e;
                                    (null === (e = this.element) || void 0 === e ? void 0 : e.classList.contains("focus")) ? this.coreService.triggerDataEvent(L.C0.ESC + "[I"): this.coreService.triggerDataEvent(L.C0.ESC + "[O")
                                }
                                _reportWindowsOptions(e) {
                                    if (this._renderService) switch (e) {
                                        case T.WindowsOptionsReportType.GET_WIN_SIZE_PIXELS:
                                            let t = this._renderService.dimensions.css.canvas.width.toFixed(0),
                                                i = this._renderService.dimensions.css.canvas.height.toFixed(0);
                                            this.coreService.triggerDataEvent(`${L.C0.ESC}[4;${i};${t}t`);
                                            break;
                                        case T.WindowsOptionsReportType.GET_CELL_SIZE_PIXELS:
                                            let s = this._renderService.dimensions.css.cell.width.toFixed(0),
                                                r = this._renderService.dimensions.css.cell.height.toFixed(0);
                                            this.coreService.triggerDataEvent(`${L.C0.ESC}[6;${r};${s}t`)
                                    }
                                }
                                cancel(e, t) {
                        ...
                        1680: function (e, t, i) {
                            ...
                            let n = i(3656),
                                ...
                                h = i(844),
                                l = i(2585),
                                c = t.Viewport = class extends h.Disposable {
                                    ...
                                    _innerRefresh() {
                                        if (this._charSizeService.height > 0) {
                                            ...
                                            let e = Math.round(this._currentRowHeight * this._lastRecordedBufferLength) + (this._lastRecordedViewportHeight - this._renderService.dimensions.css.canvas.height);
                                        ...
                                        let e = this._bufferService.buffer.ydisp * this._currentRowHeight;
                                    ...
                                    _bubbleScroll(e, t) {
                                        let i = this._viewportElement.scrollTop + this._lastRecordedViewportHeight;
                                    ...
                                    scrollLines(e) {
                                        if (0 !== e) {
                                            if (this._optionsService.rawOptions.smoothScrollDuration) {
                                                ...
                                                this._smoothScrollState.startTime = Date.now(), 1 > this._smoothScrollPercent() ? (this._smoothScrollState.origin = this._viewportElement.scrollTop, this._smoothScrollState.target = this._smoothScrollState.origin + t, this._smoothScrollState.target = Math.max(Math.min(this._smoothScrollState.target, this._viewportElement.scrollHeight), 0), this._smoothScroll()) : this._clearSmoothScrollState()
                                    ...
                                    getBufferElements(e, t) {
                                        ...
                                        for (let t = e; t < o; t++) {
                                            let e = a.get(t);
                                            if (!e) continue;
                                            let o = null === (i = a.get(t + 1)) || void 0 === i ? void 0 : i.isWrapped;
                                    ...
                                    _applyScrollModifier(e, t) {
                                        let i = this._optionsService.rawOptions.fastScrollModifier;
                            ...
                            t.Viewport = s([r(2, l.IBufferService), r(3, l.IOptionsService), r(4, o.ICharSizeService), r(5, o.IRenderService), r(6, o.ICoreBrowserService), r(7, o.IThemeService)], c)
                        },
                        3107: function (e, t, i) {
                            var s = this && this.__decorate || function (e, t, i, s) {
                                    var r, n = arguments.length,
                            ...
                            let n = i(3656),
                                ...
                                a = i(844),
                                h = i(2585),
                                l = t.BufferDecorationRenderer = class extends a.Disposable {
                                    constructor(e, t, i, s) {
                                    ...
                                    _createElement(e) {
                                        ...
                                        let r = null !== (i = e.options.x) && void 0 !== i ? i : 0;
                                    ...
                                    _refreshXPosition(e, t = e.element) {
                                        var i;
                                        if (!t) return;
                                        let s = null !== (i = e.options.x) && void 0 !== i ? i : 0;
                            ...
                            t.BufferDecorationRenderer = s([r(1, h.IBufferService), r(2, h.IDecorationService), r(3, o.IRenderService)], l)
                        },
                        5871: (e, t) => {
                            Object.defineProperty(t, "__esModule", {
                                value: !0
                        ...
                        5744: function (e, t, i) {
                            ...
                            let n = i(5871),
                                ...
                                u = t.OverviewRulerRenderer = class extends h.Disposable {
                                    get _width() {
                                        return this._optionsService.options.overviewRulerWidth || 0
                                    }
                                    constructor(e, t, i, s, r, o, a) {
                                        var l;
                                        super(), this._viewportElement = e, this._screenElement = t, this._bufferService = i, this._decorationService = s, this._renderService = r, this._optionsService = o, this._coreBrowseService = a, this._colorZoneStore = new n.ColorZoneStore, this._shouldUpdateDimensions = !0, this._shouldUpdateAnchor = !0, this._lastKnownBufferLength = 0, this._canvas = document.createElement("canvas"), this._canvas.classList.add("xterm-decoration-overview-ruler"), this._refreshCanvasDimensions(), null === (l = this._viewportElement.parentElement) || void 0 === l || l.insertBefore(this._canvas, this._viewportElement);
                                        let c = this._canvas.getContext("2d");
                                        if (!c) throw Error("Ctx cannot be null");
                                        this._ctx = c, this._registerDecorationListeners(), this._registerBufferChangeListeners(), this._registerDimensionChangeListeners(), this.register((0, h.toDisposable)(() => {
                                            var e;
                                    ...
                                    _refreshDrawHeightConstants() {
                                        c.full = Math.round(2 * this._coreBrowseService.dpr);
                                    ...
                                    _refreshDecorations() {
                                        for (let e of (this._shouldUpdateDimensions && this._refreshCanvasDimensions(), this._ctx.clearRect(0, 0, this._canvas.width, this._canvas.height), this._colorZoneStore.clear(), this._decorationService.decorations)) this._colorZoneStore.addDecoration(e);
                                        this._ctx.lineWidth = 1;
                                        let e = this._colorZoneStore.zones;
                                        for (let t of e) "full" !== t.position && this._renderColorZone(t);
                                        for (let t of e) "full" === t.position && this._renderColorZone(t);
                            ...
                            t.OverviewRulerRenderer = s([r(2, l.IBufferService), r(3, l.IDecorationService), r(4, a.IRenderService), r(5, l.IOptionsService), r(6, a.ICoreBrowserService)], u)
                        },
                        2950: function (e, t, i) {
                            var s = this && this.__decorate || function (e, t, i, s) {
                                    var r, n = arguments.length,
                                ...
                                h = t.CompositionHelper = class {
                                    ...
                                    keydown(e) {
                                        if (this._isComposing || this._isSendingComposition) {
                                            if (229 === e.keyCode || 16 === e.keyCode || 17 === e.keyCode || 18 === e.keyCode) return !1;
                                        ...
                                        if (this._compositionView.classList.remove("active"), this._isComposing = !1, e) {
                                            ...
                                            this._isSendingComposition = !0, setTimeout(() => {
                                                if (this._isSendingComposition) {
                                                    let t;
                                                    this._isSendingComposition = !1, e.start += this._dataAlreadySent.length, (t = this._isComposing ? this._textarea.value.substring(e.start, e.end) : this._textarea.value.substring(e.start)).length > 0 && this._coreService.triggerDataEvent(t, !0)
                                                }
                                            }, 0)
                                        } else {
                                    ...
                                    updateCompositionElements(e) {
                                        if (this._isComposing) {
                                            if (this._bufferService.buffer.isCursorInViewport) {
                                                ...
                                                let r = this._compositionView.getBoundingClientRect();
                            ...
                            t.CompositionHelper = s([r(2, o.IBufferService), r(3, o.IOptionsService), r(4, o.ICoreService), r(5, n.IRenderService)], h)
                        },
                        9806: (e, t) => {
                            function i(e, t, i) {
                                let s = i.getBoundingClientRect(),
                        ...
                        9504: (e, t, i) => {
                            ...
                            function r(e, t, i, s) {
                                let r = e - n(e, i),
                                    o = t - n(t, i),
                                    l = Math.abs(r - o) - function (e, t, i) {
                                        let s = 0,
                                            r = e - n(e, i),
                                            o = t - n(t, i);
                                        for (let n = 0; n < Math.abs(r - o); n++) {
                                            let o = "A" == (e > t ? "A" : "B") ? -1 : 1,
                                                a = i.buffer.lines.get(r + o * n);
                                            (null == a ? void 0 : a.isWrapped) && s++
                                        }
                                        return s
                                    }(e, t, i);
                                return h(l, a(e > t ? "A" : "B", s))
                            }
                            ...
                            function n(e, t) {
                                ...
                                for (; r && e >= 0 && e < t.rows;) i++, r = null == (s = t.buffer.lines.get(--e)) ? void 0 : s.isWrapped;
                                return i
                            }

                            function o(e, t, i, s, r, n) {
                                let o = e,
                                    a = t,
                                    h = "";
                                for (; o !== i || a !== s;) o += r ? 1 : -1, r && o > n.cols - 1 ? (h += n.buffer.translateBufferLineToString(a, !1, e, o), o = 0, e = 0, a++) : !r && o < 0 && (h += n.buffer.translateBufferLineToString(a, !1, 0, e + 1), e = o = n.cols - 1, a--);
                                return h + n.buffer.translateBufferLineToString(a, !1, e, o)
                            }

                            function a(e, t) {
                                return s.C0.ESC + (t ? "O" : "[") + e
                            }
                            ...
                            t.moveToCellSequence = function (e, t, i, s) {
                                ...
                                let d = i.buffer.x,
                                    _ = i.buffer.y;
                                if (!i.buffer.hasScrollback) return (0 === r(_, t, i, s).length ? "" : h(o(d, _, d, _ - n(_, i), !1, i).length, a("D", s))) + r(_, t, i, s) + function (e, t, i, s, l, c) {
                                    let d, _;
                                    d = r(t, s, l, c).length > 0 ? s - n(s, l) : t;
                                    let u = (_ = r(i, s, l, c).length > 0 ? s - n(s, l) : t, e < i && _ <= s || e >= i && _ < s ? "C" : "D");
                                    return h(o(e, d, i, s, "C" === u, l).length, a(u, c))
                                }(d, _, e, t, i, s);
                                if (_ === t) return c = d > e ? "D" : "C", h(Math.abs(d - e), a(c, s));
                                c = _ > t ? "D" : "C";
                                let u = Math.abs(_ - t);
                                return h((l = _ > t ? e : d, i.cols - l + (u - 1) * i.cols + 1 + ((_ > t ? d : e) - 1)), a(c, s))
                            }
                        },
                        1296: function (e, t, i) {
                            var s = this && this.__decorate || function (e, t, i, s) {
                            ...
                            let n = i(3787),
                                ...
                                b = t.DomRenderer = class extends _.Disposable {
                                    constructor(e, t, i, s, r, a, l, c, u, g) {
                                    ...
                                    handleSelectionChanged(e, t, i) {
                                        ...
                                        let s = e[1] - this._bufferService.buffer.ydisp,
                                        ...
                                        if (i) {
                                            ...
                                            if (a.appendChild(this._createSelectionElement(n + 1, 0, this._bufferService.cols, l)), n !== o) {
                                                let e = r === o ? t[0] : this._bufferService.cols;
                                    ...
                                    _setCellUnderline(e, t, i, s, r, n) {
                                        ...
                                        let a = this._bufferService.buffer,
                                            h = a.ybase + a.y,
                                            l = Math.min(a.x, r - 1),
                                        ...
                                        for (let o = i; o <= s; ++o) {
                                            let u = o + a.ydisp,
                                                ...
                                                v = a.lines.get(u);
                                            if (!f || !v) break;
                                            f.replaceChildren(...this._rowFactory.createRow(v, u, u === h, d, _, l, c, this.dimensions.css.cell.width, this._widthCache, n ? o === i ? e : 0 : -1, n ? (o === s ? t : r) - 1 : -1))
                                        }
                                    }
                                };
                            t.DomRenderer = s([r(4, u.IInstantiationService), r(5, l.ICharSizeService), r(6, u.IOptionsService), r(7, u.IBufferService), r(8, l.ICoreBrowserService), r(9, l.IThemeService)], b)
                        },
                        3787: function (e, t, i) {
                            var s = this && this.__decorate || function (e, t, i, s) {
                                    var r, n = arguments.length,
                            ...
                            let n = i(2223),
                                ...
                                _ = i(6171),
                                u = i(3734),
                                f = t.DomRendererRowFactory = class {
                                    ...
                                    createRow(e, t, i, s, r, a, h, c, _, f, g) {
                                        ...
                                        for (let M = 0; M < b; M++) {
                                            ...
                                            let H = this._isCellInSelection(M, t),
                                                F = i && M === a,
                                                W = T && M >= f && M <= g,
                                                U = !1;
                                            ...
                                            if (" " === N && (I.isUnderline() || I.isOverline()) && (N = "\xa0"), A = b * c - _.get(N, I.isBold(), I.isItalic()), C) {
                                                if (y && (H && R || !H && !R && I.bg === E) && (H && R && S.selectionForeground || I.fg === k) && I.extended.ext === x && W === L && A === D && !F && !O && !U) {
                                                    w += N, y++;
                                                    continue
                                                }
                                                y && (C.textContent = w), C = this._document.createElement("span"), y = 0, w = ""
                                            } else C = this._document.createElement("span");
                                            if (E = I.bg, k = I.fg, x = I.extended.ext, L = W, D = A, R = H, O && a >= M && a <= P && (a = M), !this._coreService.isCursorHidden && F) {
                                            ...
                                            }), !J && H && (z = (V = this._coreBrowserService.isFocused ? S.selectionBackgroundOpaque : S.selectionInactiveBackgroundOpaque).rgba >> 8 & 16777215, K = 50331648, J = !0, S.selectionForeground && (j = 50331648, $ = S.selectionForeground.rgba >> 8 & 16777215, G = S.selectionForeground)), J && B.push("xterm-decoration-top"), K) {
                                                case 16777216:
                                                case 33554432:
                                                    X = S.ansi[z], B.push(`xterm-bg-${z}`);
                                                    break;
                                                case 50331648:
                                                    X = l.rgba.toColor(z >> 16, z >> 8 & 255, 255 & z), this._addStyle(C, `background-color:#${v((z>>>0).toString(16),"0",6)}`);
                                                    break;
                                                default:
                                                    q ? (X = S.foreground, B.push(`xterm-bg-${n.INVERTED_DEFAULT_COLOR}`)) : X = S.background
                                            }
                                            switch (V || I.isDim() && (V = l.color.multiplyOpacity(X, .5)), j) {
                                                case 16777216:
                                                case 33554432:
                                                    ...
                                                    break;
                                                case 50331648:
                                                    let Y = l.rgba.toColor($ >> 16 & 255, $ >> 8 & 255, 255 & $);
                                                    this._applyMinimumContrast(C, X, Y, I, V, G) || this._addStyle(C, `color:#${v($.toString(16),"0",6)}`);
                                                    break;
                                                default:
                                    ...
                                    _applyMinimumContrast(e, t, i, s, r, n) {
                                        ...
                                        let a = this._getContrastCache(s);
                                        if (r || n || (o = a.getColor(t.rgba, i.rgba)), void 0 === o) {
                                            let e = this._optionsService.rawOptions.minimumContrastRatio / (s.isDim() ? 2 : 1);
                                            o = l.color.ensureContrastRatio(r || t, n || i, e), a.setColor((r || t).rgba, (n || i).rgba, null != o ? o : null)
                                        }
                                        return !!o && (this._addStyle(e, `color:${o.css}`), !0)
                                    }
                                    _getContrastCache(e) {
                            ...
                            t.DomRendererRowFactory = s([r(1, c.ICharacterJoinerService), r(2, h.IOptionsService), r(3, c.ICoreBrowserService), r(4, h.ICoreService), r(5, h.IDecorationService), r(6, c.IThemeService)], f)
                        },
                        2550: (e, t) => {
                            Object.defineProperty(t, "__esModule", {
                                value: !0
                                ...
                                constructor(e) {
                                    ...
                                    r.style.fontWeight = "bold", r.style.fontStyle = "italic", this._measureElements = [t, i, s, r], this._container.appendChild(t), this._container.appendChild(i), this._container.appendChild(s), this._container.appendChild(r), e.body.appendChild(this._container), this.clear()
                                }
                                dispose() {
                        ...
                        428: function (e, t, i) {
                            ...
                            let n = i(2585),
                                o = i(8460),
                                a = i(844),
                                h = t.CharSizeService = class extends a.Disposable {
                                    get hasValidSize() {
                        ...
                        4269: function (e, t, i) {
                            ...
                            let c = t.CharacterJoinerService = class e {
                                    ...
                                    for (let e = 0; e < t.getTrimmedLength(); e++)
                                        if (t.loadCell(e, this._workCell), 0 !== this._workCell.getWidth()) {
                                            if (this._workCell.fg !== h || this._workCell.bg !== l) {
                                                if (e - r > 1) {
                                                    let e = this._getJoinedRanges(s, a, n, t, r);
                                ...
                                _getJoinedRanges(t, i, s, r, n) {
                                    ...
                                    for (let t = 1; t < this._characterJoiners.length; t++) try {
                                        let i = this._characterJoiners[t].handler(o);
                            ...
                            t.CharacterJoinerService = s([r(0, h.IBufferService)], c)
                        },
                        5114: (e, t) => {
                            Object.defineProperty(t, "__esModule", {
                                value: !0
                        ...
                        8934: function (e, t, i) {
                            ...
                            let n = i(4725),
                                ...
                                a = t.MouseService = class {
                                    ...
                                    getMouseReportCoords(e, t) {
                                        let i = (0, o.getCoordsRelativeToElement)(window, e, t);
                            ...
                            t.MouseService = s([r(0, n.IRenderService), r(1, n.ICharSizeService)], a)
                        },
                        3230: function (e, t, i) {
                            var s = this && this.__decorate || function (e, t, i, s) {
                                    var r, n = arguments.length,
                                ...
                                u = t.RenderService = class extends c.Disposable {
                                    ...
                                    constructor(e, t, i, s, r, h, _, u) {
                                        if (super(), this._rowCount = e, this._charSizeService = s, this._renderer = this.register(new c.MutableDisposable), this._pausedResizeTask = new d.DebouncedIdleTask, this._isPaused = !1, this._needsFullRefresh = !1, this._isNextRenderRedrawOnly = !0, this._needsSelectionRefresh = !1, this._canvasWidth = 0, this._canvasHeight = 0, this._selectionState = {
                                            ...
                                            let e = new _.window.IntersectionObserver(e => this._handleIntersectionChange(e[e.length - 1]), {
                                                threshold: 0
                                            });
                            ...
                            t.RenderService = s([r(2, _.IOptionsService), r(3, h.ICharSizeService), r(4, _.IDecorationService), r(5, _.IBufferService), r(6, h.ICoreBrowserService), r(7, h.IThemeService)], u)
                        },
                        9312: function (e, t, i) {
                            var s = this && this.__decorate || function (e, t, i, s) {
                                    var r, n = arguments.length,
                            ...
                            let n = i(9806),
                                ...
                                g = RegExp(v, "g"),
                                p = t.SelectionService = class extends c.Disposable {
                                    ...
                                    get selectionText() {
                                        ...
                                        if (3 === this._activeSelectionMode) {
                                            if (e[0] === t[0]) return "";
                                            let r = e[0] < t[0] ? e[0] : t[0],
                                                n = e[0] < t[0] ? t[0] : e[0];
                                            for (let o = e[1]; o <= t[1]; o++) {
                                                let e = i.translateBufferLineToString(o, !0, r, n);
                                                s.push(e)
                                            }
                                        } else {
                                    ...
                                    isCellInSelection(e, t) {
                                        let i = this._model.finalSelectionStart,
                                            s = this._model.finalSelectionEnd;
                                    ...
                                    _selectWordAtCursor(e, t) {
                                        var i, s;
                                        let r = null === (s = null === (i = this._linkifier.currentLink) || void 0 === i ? void 0 : i.link) || void 0 === s ? void 0 : s.range;
                                    ...
                                    _getMouseEventScrollAmount(e) {
                                        let t = (0, n.getCoordsRelativeToElement)(this._coreBrowserService.window, e, this._screenElement)[1],
                                            i = this._renderService.dimensions.css.canvas.height;
                                        return t >= 0 && t <= i ? 0 : (t > i && (t -= i), (t = Math.min(Math.max(t, -50), 50) / 50) / Math.abs(t) + Math.round(14 * t))
                                    }
                                    ...
                                    _handleMouseMove(e) {
                                        ...
                                        if (this._model.selectionEnd[1] < i.lines.length) {
                                            let e = i.lines.get(this._model.selectionEnd[1]);
                                        ...
                                        if (this._removeMouseDownListeners(), this.selectionText.length <= 1 && t < 500 && e.altKey && this._optionsService.rawOptions.altClickMovesCursor) {
                                            if (this._bufferService.buffer.ybase === this._bufferService.buffer.ydisp) {
                                                ...
                                                if (t && void 0 !== t[0] && void 0 !== t[1]) {
                                                    let e = (0, o.moveToCellSequence)(t[0] - 1, t[1] - 1, this._bufferService, this._coreService.decPrivateModes.applicationCursorKeys);
                                                    this._coreService.triggerDataEvent(e, !0)
                                                }
                                            }
                                    ...
                                    _getWordAt(e, t, i = !0, s = !0) {
                                        ...
                                        let r = this._bufferService.buffer,
                                            n = r.lines.get(e[1]);
                                        if (!n) return;
                                        let o = r.translateBufferLineToString(e[1], !1),
                                            a = this._convertViewportColToCharacterIndex(n, e[0]),
                                            h = a,
                                            l = e[0] - a,
                                            c = 0,
                                            d = 0,
                                        ...
                                        h++;
                                        let f = a + l - c + _,
                                            v = Math.min(this._bufferService.cols, h - a + c + d - _ - u);
                                        if (t || "" !== o.slice(a, h).trim()) {
                                            if (i && 0 === f && 32 !== n.getCodePoint(0)) {
                                                let t = r.lines.get(e[1] - 1);
                            ...
                            t.SelectionService = s([r(3, f.IBufferService), r(4, f.ICoreService), r(5, h.IMouseService), r(6, f.IOptionsService), r(7, h.IRenderService), r(8, h.ICoreBrowserService)], p)
                        },
                        4725: (e, t, i) => {
                            Object.defineProperty(t, "__esModule", {
                                value: !0
                        ...
                        6731: function (e, t, i) {
                            ...
                            t.DEFAULT_ANSI_COLORS = Object.freeze((() => {
                                let e = [o.css.toColor("#2e3436"), o.css.toColor("#cc0000"), o.css.toColor("#4e9a06"), o.css.toColor("#c4a000"), o.css.toColor("#3465a4"), o.css.toColor("#75507b"), o.css.toColor("#06989a"), o.css.toColor("#d3d7cf"), o.css.toColor("#555753"), o.css.toColor("#ef2929"), o.css.toColor("#8ae234"), o.css.toColor("#fce94f"), o.css.toColor("#729fcf"), o.css.toColor("#ad7fa8"), o.css.toColor("#34e2e2"), o.css.toColor("#eeeeec")],
                            ...
                            t.ThemeService = s([r(0, l.IOptionsService)], v)
                        },
                        6349: (e, t, i) => {
                            Object.defineProperty(t, "__esModule", {
                                value: !0
                            ...
                            class n extends r.Disposable {
                                ...
                                splice(e, t, ...i) {
                                    ...
                                    if (i.length && this.onInsertEmitter.fire({
                                        ...
                                        let e = this._length + i.length - this._maxLength;
                                ...
                                shiftElements(e, t, i) {
                                    if (!(t <= 0)) {
                                        ...
                                        if (e + i < 0) throw Error("Cannot shift elements in list beyond index 0");
                                        if (i > 0) {
                        ...
                        1439: (e, t) => {
                            Object.defineProperty(t, "__esModule", {
                                ...
                                for (let r in t) s[r] = i <= 1 ? t[r] : t[r] && e(t[r], i - 1);
                                return s
                            }
                        },
                        8055: (e, t, i) => {
                            ...
                            t.NULL_COLOR = {
                                    css: "#00000000",
                                    rgba: 0
                                }, (h = s || (t.channels = s = {})).toCss = function (e, t, i, s) {
                                    return void 0 !== s ? `#${f(e)}${f(t)}${f(i)}${f(s)}` : `#${f(e)}${f(t)}${f(i)}`
                                }, h.toRgba = function (e, t, i, s = 255) {
                                    return (e << 24 | t << 16 | i << 8 | s) >>> 0
                                },
                                function (e) {
                                    function t(e, t) {
                                        return u = Math.round(255 * t), [c, d, _] = a.toChannels(e.rgba), {
                                            css: s.toCss(c, d, _, u),
                                            rgba: s.toRgba(c, d, _, u)
                                        }
                                    }
                                    e.blend = function (e, t) {
                                        if (1 == (u = (255 & t.rgba) / 255)) return {
                                            css: t.css,
                                            rgba: t.rgba
                                        };
                                        let i = t.rgba >> 24 & 255,
                                            ...
                                            a = e.rgba >> 16 & 255,
                                            h = e.rgba >> 8 & 255;
                                        return c = o + Math.round((i - o) * u), d = a + Math.round((r - a) * u), _ = h + Math.round((n - h) * u), {
                                            css: s.toCss(c, d, _),
                                            rgba: s.toRgba(c, d, _)
                                        }
                                        ...
                                        let s = a.ensureContrastRatio(e.rgba, t.rgba, i);
                                        if (s) return a.toColor(s >> 24 & 255, s >> 16 & 255, s >> 8 & 255)
                                    }, e.opaque = function (e) {
                                        let t = (255 | e.rgba) >>> 0;
                                        return [c, d, _] = a.toChannels(t), {
                                            css: s.toCss(c, d, _),
                                            rgba: t
                                        }
                                    }, e.opacity = t, e.multiplyOpacity = function (e, i) {
                                        return u = 255 & e.rgba, t(e, u * i / 255)
                                ...
                                function (e) {
                                    ...
                                    if (!l.isNode) {
                                        ...
                                        s && ((t = s).globalCompositeOperation = "copy", i = t.createLinearGradient(0, 0, 1, 1))
                                    }
                                    e.toColor = function (e) {
                                        if (e.match(/#[\da-f]{3,8}/i)) switch (e.length) {
                                            case 4:
                                                return c = parseInt(e.slice(1, 2).repeat(2), 16), d = parseInt(e.slice(2, 3).repeat(2), 16), _ = parseInt(e.slice(3, 4).repeat(2), 16), a.toColor(c, d, _);
                                            case 5:
                                                return c = parseInt(e.slice(1, 2).repeat(2), 16), d = parseInt(e.slice(2, 3).repeat(2), 16), _ = parseInt(e.slice(3, 4).repeat(2), 16), u = parseInt(e.slice(4, 5).repeat(2), 16), a.toColor(c, d, _, u);
                                            case 7:
                                                return {
                                        ...
                                        if (r) return c = parseInt(r[1]), d = parseInt(r[2]), _ = parseInt(r[3]), u = Math.round(255 * (void 0 === r[5] ? 1 : parseFloat(r[5]))), a.toColor(c, d, _, u);
                                        if (!t || !i || (t.fillStyle = i, t.fillStyle = e, "string" != typeof t.fillStyle) || (t.fillRect(0, 0, 1, 1), [c, d, _, u] = t.getImageData(0, 0, 1, 1).data, 255 !== u)) throw Error("css.toColor: Unsupported css format");
                                        return {
                                            rgba: s.toRgba(c, d, _, u),
                                            css: e
                                        }
                                ...
                                function (e) {
                                    function t(e, t, i) {
                                        let s = e >> 24 & 255,
                                            ...
                                            h = t >> 16 & 255,
                                            l = t >> 8 & 255,
                                            c = v(o.relativeLuminance2(a, h, l), o.relativeLuminance2(s, r, n));
                                        for (; c < i && (a > 0 || h > 0 || l > 0);) a -= Math.max(0, Math.ceil(.1 * a)), h -= Math.max(0, Math.ceil(.1 * h)), l -= Math.max(0, Math.ceil(.1 * l)), c = v(o.relativeLuminance2(a, h, l), o.relativeLuminance2(s, r, n));
                                        return (a << 24 | h << 16 | l << 8 | 255) >>> 0
                                    }
                                    ...
                                    function i(e, t, i) {
                                        let s = e >> 24 & 255,
                                            ...
                                            l = t >> 8 & 255,
                                            c = v(o.relativeLuminance2(a, h, l), o.relativeLuminance2(s, r, n));
                                        for (; c < i && (a < 255 || h < 255 || l < 255);) a = Math.min(255, a + Math.ceil(.1 * (255 - a))), h = Math.min(255, h + Math.ceil(.1 * (255 - h))), l = Math.min(255, l + Math.ceil(.1 * (255 - l))), c = v(o.relativeLuminance2(a, h, l), o.relativeLuminance2(s, r, n));
                                        return (a << 24 | h << 16 | l << 8 | 255) >>> 0
                                    }
                                    e.ensureContrastRatio = function (e, s, r) {
                                        let n = o.relativeLuminance(e >> 8),
                                            a = o.relativeLuminance(s >> 8);
                                        if (v(n, a) < r) {
                                            if (a < n) {
                                                let a = t(e, s, r),
                                                    h = v(n, o.relativeLuminance(a >> 8));
                                                if (h < r) {
                                                    let t = i(e, s, r);
                                                    return h > v(n, o.relativeLuminance(t >> 8)) ? a : t
                                                }
                                                return a
                                            }
                                            let h = i(e, s, r),
                                                l = v(n, o.relativeLuminance(h >> 8));
                                            if (l < r) {
                                                let i = t(e, s, r);
                                                return l > v(n, o.relativeLuminance(i >> 8)) ? h : i
                                            }
                                            return h
                                        }
                                    }, e.reduceLuminance = t, e.increaseLuminance = i, e.toChannels = function (e) {
                                        return [e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, 255 & e]
                                    }, e.toColor = function (e, t, i, r) {
                                        return {
                                            css: s.toCss(e, t, i, r),
                                            rgba: s.toRgba(e, t, i, r)
                                        }
                                    }
                                }(a || (t.rgba = a = {})), t.toPaddedHex = f, t.contrastRatio = v
                        },
                        8969: (e, t, i) => {
                            Object.defineProperty(t, "__esModule", {
                                value: !0
                        ...
                        5435: function (e, t, i) {
                            var s, r, n = this && this.__decorate || function (e, t, i, s) {
                                    var r, n = arguments.length,
                                        o = n < 3 ? t : null === s ? s = Object.getOwnPropertyDescriptor(t, i) : s;
                                    if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) o = Reflect.decorate(e, t, i, s);
                                    else
                            ...
                            class E extends c.Disposable {
                                ...
                                constructor(e, t, i, s, r, n, o, c, f = new l.EscapeSequenceParser) {
                                    for (let l in super(), this._bufferService = e, this._charsetService = t, this._coreService = i, this._logService = s, this._optionsService = r, this._oscLinkService = n, this._coreMouseService = o, this._unicodeService = c, this._parser = f, this._parseBuffer = new Uint32Array(4096), this._stringDecoder = new d.StringToUtf32, this._utf8Decoder = new d.Utf8ToUtf32, this._workCell = new v.CellData, this._windowTitle = "", this._iconName = "", this._windowTitleStack = [], this._iconNameStack = [], this._curAttrData = _.DEFAULT_ATTR_DATA.clone(), this._eraseAttrDataInternal = _.DEFAULT_ATTR_DATA.clone(), this._onRequestBell = this.register(new u.EventEmitter), this.onRequestBell = this._onRequestBell.event, this._onRequestRefreshRows = this.register(new u.EventEmitter), this.onRequestRefreshRows = this._onRequestRefreshRows.event, this._onRequestReset = this.register(new u.EventEmitter), this.onRequestReset = this._onRequestReset.event, this._onRequestSendFocus = this.register(new u.EventEmitter), this.onRequestSendFocus = this._onRequestSendFocus.event, this._onRequestSyncScrollBar = this.register(new u.EventEmitter), this.onRequestSyncScrollBar = this._onRequestSyncScrollBar.event, this._onRequestWindowsOptionsReport = this.register(new u.EventEmitter), this.onRequestWindowsOptionsReport = this._onRequestWindowsOptionsReport.event, this._onA11yChar = this.register(new u.EventEmitter), this.onA11yChar = this._onA11yChar.event, this._onA11yTab = this.register(new u.EventEmitter), this.onA11yTab = this._onA11yTab.event, this._onCursorMove = this.register(new u.EventEmitter), this.onCursorMove = this._onCursorMove.event, this._onLineFeed = this.register(new u.EventEmitter), this.onLineFeed = this._onLineFeed.event, this._onScroll = this.register(new u.EventEmitter), this.onScroll = this._onScroll.event, this._onTitleChange = this.register(new u.EventEmitter), this.onTitleChange = this._onTitleChange.event, this._onColor = this.register(new u.EventEmitter), this.onColor = this._onColor.event, this._parseStack = {
                                            ...
                                            intermediates: "%",
                                            final: "G"
                                        }, () => this.selectDefaultCharset()), h.CHARSETS) this._parser.registerEscHandler({
                                        intermediates: "(",
                                        final: l
                                    }, () => this.selectCharset("(" + l)), this._parser.registerEscHandler({
                                        intermediates: ")",
                                        final: l
                                    }, () => this.selectCharset(")" + l)), this._parser.registerEscHandler({
                                        intermediates: "*",
                                    ...
                                    this._parser.registerEscHandler({
                                        ...
                                        intermediates: "$",
                                        final: "q"
                                    }, new S.DcsHandler((e, t) => this.requestStatusString(e, t)))
                                }
                                ...
                                _logSlowResolvingAsync(e) {
                                    this._logService.logLevel <= p.LogLevelEnum.WARN && Promise.race([e, new Promise((e, t) => setTimeout(() => t("#SLOW_TIMEOUT"), 5e3))]).catch(e => {
                                ...
                                parse(e, t) {
                                    ...
                                    if (o) {
                                        ...
                                        s = this._parseStack.cursorStartX, r = this._parseStack.cursorStartY, this._parseStack.paused = !1, e.length > 131072 && (n = this._parseStack.position + 131072)
                                    }
                                    if (this._logService.logLevel <= p.LogLevelEnum.DEBUG && this._logService.debug("parsing data" + ("string" == typeof e ? ` "${e}"` : ` "${Array.prototype.map.call(e,e=>String.fromCharCode(e)).join("")}"`), "string" == typeof e ? e.split("").map(e => e.charCodeAt(0)) : e), this._parseBuffer.length < e.length && this._parseBuffer.length < 131072 && (this._parseBuffer = new Uint32Array(Math.min(e.length, 131072))), o || this._dirtyRowTracker.clearRange(), e.length > 131072)
                                        for (let t = n; t < e.length; t += 131072) {
                                            let n = t + 131072 < e.length ? t + 131072 : e.length,
                                            ...
                                            let t = "string" == typeof e ? this._stringDecoder.decode(e, this._parseBuffer) : this._utf8Decoder.decode(e, this._parseBuffer);
                                ...
                                print(e, t, i) {
                                    let s, r;
                                    let n = this._charsetService.charset,
                                        ...
                                        c = this._curAttrData,
                                        _ = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y);
                                    this._dirtyRowTracker.markDirty(this._activeBuffer.y), this._activeBuffer.x && i - t > 0 && 2 === _.getWidth(this._activeBuffer.x - 1) && _.setCellFromCodePoint(this._activeBuffer.x - 1, 0, 1, c.fg, c.bg, c.extended);
                                    for (let u = t; u < i; ++u) {
                                        if (s = e[u], r = this._unicodeService.wcwidth(s), s < 127 && n) {
                                            let e = n[String.fromCharCode(s)];
                                            e && (s = e.charCodeAt(0))
                                        }
                                        if (o && this._onA11yChar.fire((0, d.stringFromCodePoint)(s)), this._getCurrentLinkId() && this._oscLinkService.addLineToLink(this._getCurrentLinkId(), this._activeBuffer.ybase + this._activeBuffer.y), r || !this._activeBuffer.x) {
                                            if (this._activeBuffer.x + r - 1 >= a) {
                                                if (h) {
                                                    for (; this._activeBuffer.x < a;) _.setCellFromCodePoint(this._activeBuffer.x++, 0, 1, c.fg, c.bg, c.extended);
                                                    this._activeBuffer.x = 0, this._activeBuffer.y++, this._activeBuffer.y === this._activeBuffer.scrollBottom + 1 ? (this._activeBuffer.y--, this._bufferService.scroll(this._eraseAttrData(), !0)) : (this._activeBuffer.y >= this._bufferService.rows && (this._activeBuffer.y = this._bufferService.rows - 1), this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y).isWrapped = !0), _ = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y)
                                                } else if (this._activeBuffer.x = a - 1, 2 === r) continue
                                            }
                                            if (l && (_.insertCells(this._activeBuffer.x, r, this._activeBuffer.getNullCell(c), c), 2 === _.getWidth(a - 1) && _.setCellFromCodePoint(a - 1, f.NULL_CELL_CODE, f.NULL_CELL_WIDTH, c.fg, c.bg, c.extended)), _.setCellFromCodePoint(this._activeBuffer.x++, s, r, c.fg, c.bg, c.extended), r > 0)
                                                for (; --r;) _.setCellFromCodePoint(this._activeBuffer.x++, 0, 0, c.fg, c.bg, c.extended)
                                        } else _.getWidth(this._activeBuffer.x - 1) ? _.addCodepointToCell(this._activeBuffer.x - 1, s) : _.addCodepointToCell(this._activeBuffer.x - 2, s)
                                    }
                                    i - t > 0 && (_.loadCell(this._activeBuffer.x - 1, this._workCell), 2 === this._workCell.getWidth() || this._workCell.getCode() > 65535 ? this._parser.precedingCodepoint = 0 : this._workCell.isCombined() ? this._parser.precedingCodepoint = this._workCell.getChars().charCodeAt(0) : this._parser.precedingCodepoint = this._workCell.content), this._activeBuffer.x < a && i - t > 0 && 0 === _.getWidth(this._activeBuffer.x) && !_.hasContent(this._activeBuffer.x) && _.setCellFromCodePoint(this._activeBuffer.x, 0, 1, c.fg, c.bg, c.extended), this._dirtyRowTracker.markDirty(this._activeBuffer.y)
                                }
                                registerCsiHandler(e, t) {
                                ...
                                registerDcsHandler(e, t) {
                                    return this._parser.registerDcsHandler(e, new S.DcsHandler(t))
                                }
                                registerEscHandler(e, t) {
                                ...
                                insertLines(e) {
                                    ...
                                    let i = this._activeBuffer.ybase + this._activeBuffer.y,
                                ...
                                deleteLines(e) {
                                    ...
                                    let i = e.params[0] || 1;
                                    if (this._activeBuffer.y > this._activeBuffer.scrollBottom || this._activeBuffer.y < this._activeBuffer.scrollTop) return !0;
                                    let s = this._activeBuffer.ybase + this._activeBuffer.y;
                                    for (t = this._bufferService.rows - 1 - this._activeBuffer.scrollBottom, t = this._bufferService.rows - 1 + this._activeBuffer.ybase - t; i--;) this._activeBuffer.lines.splice(s, 1), this._activeBuffer.lines.splice(t, 0, this._activeBuffer.getBlankLine(this._eraseAttrData()));
                                    return this._dirtyRowTracker.markRangeDirty(this._activeBuffer.y, this._activeBuffer.scrollBottom), this._activeBuffer.x = 0, !0
                                }
                                insertChars(e) {
                                    this._restrictCursor();
                                ...
                                scrollDown(e) {
                                    let t = e.params[0] || 1;
                                    for (; t--;) this._activeBuffer.lines.splice(this._activeBuffer.ybase + this._activeBuffer.scrollBottom, 1), this._activeBuffer.lines.splice(this._activeBuffer.ybase + this._activeBuffer.scrollTop, 0, this._activeBuffer.getBlankLine(_.DEFAULT_ATTR_DATA));
                                    return this._dirtyRowTracker.markRangeDirty(this._activeBuffer.scrollTop, this._activeBuffer.scrollBottom), !0
                                }
                                scrollLeft(e) {
                                    if (this._activeBuffer.y > this._activeBuffer.scrollBottom || this._activeBuffer.y < this._activeBuffer.scrollTop) return !0;
                                ...
                                sendDeviceAttributesPrimary(e) {
                                    return e.params[0] > 0 || (this._is("xterm") || this._is("rxvt-unicode") || this._is("screen") ? this._coreService.triggerDataEvent(a.C0.ESC + "[?1;2c") : this._is("linux") && this._coreService.triggerDataEvent(a.C0.ESC + "[?6c")), !0
                                }
                                sendDeviceAttributesSecondary(e) {
                                    return e.params[0] > 0 || (this._is("xterm") ? this._coreService.triggerDataEvent(a.C0.ESC + "[>0;276;0c") : this._is("rxvt-unicode") ? this._coreService.triggerDataEvent(a.C0.ESC + "[>85;95;0c") : this._is("linux") ? this._coreService.triggerDataEvent(e.params[0] + "c") : this._is("screen") && this._coreService.triggerDataEvent(a.C0.ESC + "[>83;40003;0c")), !0
                                }
                                _is(e) {
                                ...
                                _extractColor(e, t, i) {
                                    ...
                                    do {
                                        if (s[n + r] = e.params[t + n], e.hasSubParams(t + n)) {
                                            let i = e.getSubParams(t + n),
                                                o = 0;
                                            do 5 === s[1] && (r = 1), s[n + o + 1 + r] = i[o]; while (++o < i.length && o + n + 1 + r < s.length);
                                            break
                                        }
                                ...
                                _processSGR0(e) {
                                    e.fg = _.DEFAULT_ATTR_DATA.fg, e.bg = _.DEFAULT_ATTR_DATA.bg, e.extended = e.extended.clone(), e.extended.underlineStyle = 0, e.extended.underlineColor &= -67108864, e.updateExtended()
                                }
                                charAttributes(e) {
                                    let t;
                                ...
                                deviceStatus(e) {
                                    switch (e.params[0]) {
                                        case 5:
                                            ...
                                            break;
                                        case 6:
                                            let t = this._activeBuffer.y + 1,
                                                i = this._activeBuffer.x + 1;
                                            this._coreService.triggerDataEvent(`${a.C0.ESC}[${t};${i}R`)
                                    }
                                    return !0
                                }
                                deviceStatusPrivate(e) {
                                    if (6 === e.params[0]) {
                                        ...
                                        this._coreService.triggerDataEvent(`${a.C0.ESC}[?${e};${t}R`)
                                    }
                                    return !0
                                }
                                softReset(e) {
                                ...
                                setCursorStyle(e) {
                                    ...
                                    return this._optionsService.options.cursorBlink = t % 2 == 1, !0
                                }
                                setScrollRegion(e) {
                                    let t;
                                    let i = e.params[0] || 1;
                                    return (e.length < 2 || (t = e.params[1]) > this._bufferService.rows || 0 === t) && (t = this._bufferService.rows), t > i && (this._activeBuffer.scrollTop = i - 1, this._activeBuffer.scrollBottom = t - 1, this._setCursor(0, 0)), !0
                                }
                                windowOptions(e) {
                                    ...
                                    switch (e.params[0]) {
                                        case 14:
                                            2 !== t && this._onRequestWindowsOptionsReport.fire(r.GET_WIN_SIZE_PIXELS);
                                            break;
                                        case 16:
                                            this._onRequestWindowsOptionsReport.fire(r.GET_CELL_SIZE_PIXELS);
                                            break;
                                        case 18:
                                ...
                                _createHyperlink(e, t) {
                                    ...
                                    let s = e.split(":"),
                                        r = s.findIndex(e => e.startsWith("id="));
                                    return -1 !== r && (i = s[r].slice(3) || void 0), this._curAttrData.extended = this._curAttrData.extended.clone(), this._curAttrData.extended.urlId = this._oscLinkService.registerLink({
                                        id: i,
                                        uri: t
                                ...
                                selectCharset(e) {
                                    return 2 !== e.length ? this.selectDefaultCharset() : "/" === e[0] || this._charsetService.setgCharset(b[e[0]], h.CHARSETS[e[1]] || h.DEFAULT_CHARSET), !0
                                }
                                index() {
                                ...
                                reset() {
                                    this._curAttrData = _.DEFAULT_ATTR_DATA.clone(), this._eraseAttrDataInternal = _.DEFAULT_ATTR_DATA.clone()
                                }
                                _eraseAttrData() {
                                ...
                                screenAlignmentPattern() {
                                    ...
                                    for (let t = 0; t < this._bufferService.rows; ++t) {
                                        let i = this._activeBuffer.ybase + this._activeBuffer.y + t,
                                ...
                                requestStatusString(e, t) {
                                    ...
                                    return i = '"q' === e ? `P1$r${this._curAttrData.isProtected()?1:0}"q` : '"p' === e ? 'P1$r61;1"p' : "r" === e ? `P1$r${s.scrollTop+1};${s.scrollBottom+1}r` : "m" === e ? "P1$r0m" : " q" === e ? `P1$r${({block:2,underline:4,bar:6})[r.cursorStyle]-(r.cursorBlink?1:0)} q` : "P0$r", this._coreService.triggerDataEvent(`${a.C0.ESC}${i}${a.C0.ESC}\\`), !0
                                }
                                markRangeDirty(e, t) {
                        ...
                        844: (e, t) => {
                            ...
                            Object.defineProperty(t, "__esModule", {
                                ...
                                dispose() {
                                    for (let e of (this._isDisposed = !0, this._disposables)) e.dispose();
                                ...
                                unregister(e) {
                                    let t = this._disposables.indexOf(e); - 1 !== t && this._disposables.splice(t, 1)
                                }
                        ...
                        6114: (e, t) => {
                            ...
                            let i = t.isNode ? "node" : navigator.userAgent,
                        ...
                        6106: (e, t) => {
                            ...
                            t.SortedList = class {
                                ...
                                delete(e) {
                                    ...
                                    if (void 0 === t || -1 === (i = this._search(t)) || this._getKey(this._array[i]) !== t) return !1;
                                    do
                                        if (this._array[i] === e) return this._array.splice(i, 1), !0; while (++i < this._array.length && this._getKey(this._array[i]) === t);
                                    return !1
                                }* getKeyIterator(e) {
                                    if (0 !== this._array.length && !((i = this._search(e)) < 0 || i >= this._array.length) && this._getKey(this._array[i]) === e)
                                        do yield this._array[i]; while (++i < this._array.length && this._getKey(this._array[i]) === e)
                                }
                                forEachByKey(e, t) {
                                    if (0 !== this._array.length && !((i = this._search(e)) < 0 || i >= this._array.length) && this._getKey(this._array[i]) === e)
                                        do t(this._array[i]); while (++i < this._array.length && this._getKey(this._array[i]) === e)
                                }
                                values() {
                            ...
                            class r {
                                ...
                                _process(e) {
                                    ...
                                    for (; this._i < this._tasks.length;) {
                                        if (t = Date.now(), this._tasks[this._i]() || this._i++, 1.5 * (i = Math.max(t = Math.max(1, Date.now() - t), i)) > (r = e.timeRemaining())) return s - t < -20 && console.warn(`task queue exceeded allotted deadline by ${Math.abs(Math.round(s-t))}ms`), void this._start();
                                        s = r
                                    }
                                    this.clear()
                                }
                        ...
                        9282: (e, t, i) => {
                            ...
                            t.updateWindowsModeWrappedState = function (e) {
                                let t = e.buffer.lines.get(e.buffer.ybase + e.buffer.y - 1),
                        ...
                        9092: (e, t, i) => {
                            ...
                            t.MAX_BUFFER_SIZE = 4294967295, t.Buffer = class {
                                ...
                                _getCorrectBufferLength(e) {
                                    ...
                                    let i = e + this._optionsService.rawOptions.scrollback;
                                ...
                                resize(e, t) {
                                    let i = this.getNullCell(o.DEFAULT_ATTR_DATA),
                                        s = 0,
                                ...
                                _batchedMemoryCleanup() {
                                    ...
                                    for (; this._memoryCleanupPosition < this.lines.length;)
                                        if ((t += this.lines.get(this._memoryCleanupPosition++).cleanupMemory()) > 100) return !0;
                                    return e
                                }
                                ...
                                _reflowLarger(e, t) {
                                    let i = (0, a.reflowLargerGetLinesToRemove)(this.lines, this._cols, e, this.ybase + this.y, this.getNullCell(o.DEFAULT_ATTR_DATA));
                                    if (i.length > 0) {
                                        let s = (0, a.reflowLargerCreateNewLayout)(this.lines, i);
                                ...
                                _reflowLargerAdjustViewport(e, t, i) {
                                    let s = this.getNullCell(o.DEFAULT_ATTR_DATA),
                                        r = i;
                                ...
                                _reflowSmaller(e, t) {
                                    ...
                                    for (let n = this.lines.length - 1; n >= 0; n--) {
                                        let h, l = this.lines.get(n);
                                        if (!l || !l.isWrapped && l.getTrimmedLength() <= e) continue;
                                        let c = [l];
                                        for (; l.isWrapped && n > 0;) l = this.lines.get(--n), c.unshift(l);
                                        let d = this.ybase + this.y;
                                        if (d >= n && d < n + c.length) continue;
                                        let _ = c[c.length - 1].getTrimmedLength(),
                                            u = (0, a.reflowSmallerGetNewLineLengths)(c, this._cols, e),
                                            f = u.length - c.length;
                                        h = 0 === this.ybase && this.y !== this.lines.length - 1 ? Math.max(0, this.y - this.lines.maxLength + f) : Math.max(0, this.lines.length - this.lines.maxLength + f);
                                        let v = [];
                                        for (let e = 0; e < f; e++) {
                                        ...
                                        for (; m >= 0;) {
                                            let e = Math.min(S, p);
                                            if (void 0 === c[g]) break;
                                            if (c[g].copyCellsFrom(c[m], S - e, p - e, e, !0), 0 == (p -= e) && (p = u[--g]), 0 == (S -= e)) {
                                                m--;
                                                let e = Math.max(m, 0);
                                                S = (0, a.getWrappedLineTrimmedLength)(c, e, this._cols)
                                            }
                                        }
                                        for (let t = 0; t < c.length; t++) u[t] < e && c[t].setCell(u[t], i);
                                        let C = f - h;
                                    ...
                                    if (s.length > 0) {
                                        ...
                                        let c = Math.max(0, i + r - this.lines.maxLength);
                        ...
                        8437: (e, t, i) => {
                            ...
                            class h {
                                constructor(e, t, i = !1) {
                                    ...
                                    let s = t || r.CellData.fromCharData([0, n.NULL_CELL_CHAR, n.NULL_CELL_WIDTH, n.NULL_CELL_CODE]);
                                ...
                                addCodepointToCell(e, t) {
                                    ...
                                    2097152 & i ? this._combined[e] += (0, o.stringFromCodePoint)(t) : (2097151 & i ? (this._combined[e] = (0, o.stringFromCodePoint)(2097151 & i) + (0, o.stringFromCodePoint)(t), i &= -2097152, i |= 2097152) : i = 4194304 | t, this._data[3 * e + 0] = i)
                                }
                                insertCells(e, t, i, n) {
                                ...
                                copyFrom(e) {
                                    for (let t in this.length !== e.length ? this._data = new Uint32Array(e._data) : this._data.set(e._data), this.length = e.length, this._combined = {}, e._combined) this._combined[t] = e._combined[t];
                                    for (let t in this._extendedAttrs = {}, e._extendedAttrs) this._extendedAttrs[t] = e._extendedAttrs[t];
                                    this.isWrapped = e.isWrapped
                                }
                                clone() {
                                    let e = new h(0);
                                    for (let t in e._data = new Uint32Array(this._data), e.length = this.length, this._combined) e._combined[t] = this._combined[t];
                                    for (let t in this._extendedAttrs) e._extendedAttrs[t] = this._extendedAttrs[t];
                        ...
                        4634: (e, t) => {
                            function i(e, t, i) {
                                ...
                                let s = !e[t].hasContent(i - 1) && 1 === e[t].getWidth(i - 1),
                                ...
                                for (let a = 0; a < e.length - 1; a++) {
                                    ...
                                    for (; u < c.length;) {
                                        let e = i(c, u, t),
                                            ...
                                            o = s - _,
                                            a = Math.min(r, o);
                                        c[d].copyCellsFrom(c[u], f, _, a, !1), (_ += a) === s && (d++, _ = 0), (f += a) === e && (u++, f = 0), 0 === _ && 0 !== d && 2 === c[d - 1].getWidth(s - 1) && (c[d].copyCellsFrom(c[d - 1], s - 1, _++, 1, !1), c[d - 1].setCell(s - 1, n))
                                    }
                                    c[d].replaceCells(_, s, n);
                                    let v = 0;
                                    for (let e = c.length - 1; e > 0 && (e > d || 0 === c[e].getTrimmedLength()); e--) v++;
                                    v > 0 && (o.push(a + c.length - v), o.push(v)), a += c.length - 1
                                }
                                return o
                            ...
                            class o extends n.AttributeData {
                                ...
                                setFromCharData(e) {
                                    ...
                                    if (e[r.CHAR_DATA_CHAR_INDEX].length > 2) t = !0;
                                        ...
                                        let i = e[r.CHAR_DATA_CHAR_INDEX].charCodeAt(0);
                                        if (55296 <= i && i <= 56319) {
                                            let s = e[r.CHAR_DATA_CHAR_INDEX].charCodeAt(1);
                                ...
                                switch (e.keyCode) {
                                    ...
                                    default:
                                        if (!e.ctrlKey || e.shiftKey || e.altKey || e.metaKey) {
                                            if (i && !n || !e.altKey || e.metaKey) !i || e.altKey || e.ctrlKey || e.shiftKey || !e.metaKey ? !e.key || e.ctrlKey || e.altKey || e.metaKey || !(e.keyCode >= 48) || 1 !== e.key.length ? e.key && e.ctrlKey && ("_" === e.key && (o.key = s.C0.US), "@" === e.key && (o.key = s.C0.NUL)) : o.key = e.key : 65 === e.keyCode && (o.type = 1);
                                            else {
                                                let t = r[e.keyCode],
                        ...
                        482: (e, t) => {
                            Object.defineProperty(t, "__esModule", {
                                ...
                                return e > 65535 ? String.fromCharCode(55296 + ((e -= 65536) >> 10)) + String.fromCharCode(e % 1024 + 56320) : String.fromCharCode(e)
                                ...
                                decode(e, t) {
                                    ...
                                    if (this.interim[0]) {
                                        ...
                                        let h = 192 == (224 & this.interim[0]) ? 2 : 224 == (240 & this.interim[0]) ? 3 : 4,
                                            c = h - o;
                                        for (; l < c;) {
                                            if (l >= i) return 0;
                                            if (128 != (192 & (n = e[l++]))) {
                                    ...
                                    for (; d < i;) {
                                        ...
                                        if ((s = e[d++]) < 128) t[a++] = s;
                                            ...
                                            if (128 != (192 & (r = e[d++])) || (h = (31 & s) << 6 | 63 & r) < 128) {
                                                d--;
                                                continue
                                            }
                                            t[a++] = h
                                            ...
                                            if ((h = (15 & s) << 12 | (63 & r) << 6 | 63 & n) < 2048 || h >= 55296 && h <= 57343 || 65279 === h) continue;
                                            t[a++] = h
                                        } else if (240 == (248 & s)) {
                                            if (d >= i) return this.interim[0] = s, a;
                                            if (128 != (192 & (r = e[d++]))) {
                                            ...
                                            if ((h = (7 & s) << 18 | (63 & r) << 12 | (63 & n) << 6 | 63 & o) < 65536 || h > 1114111) continue;
                                            t[a++] = h
                                        }
                                    }
                                    return a
                        ...
                        225: (e, t) => {
                            ...
                            t.UnicodeV6 = class {
                                constructor() {
                                    if (this.version = "6", !i) {
                                        (i = new Uint8Array(65536)).fill(1), i[0] = 0, i.fill(0, 1, 32), i.fill(0, 127, 160), i.fill(2, 4352, 4448), i[9001] = 2, i[9002] = 2, i.fill(2, 11904, 42192), i[12351] = 1, i.fill(2, 44032, 55204), i.fill(2, 63744, 64256), i.fill(2, 65040, 65050), i.fill(2, 65072, 65136), i.fill(2, 65280, 65377), i.fill(2, 65504, 65511);
                                        for (let e = 0; e < s.length; ++e) i.fill(0, s[e][0], s[e][1] + 1)
                                    }
                                }
                                wcwidth(e) {
                                    return e < 32 ? 0 : e < 127 ? 1 : e < 65536 ? i[e] : ! function (e, t) {
                                        ...
                                        for (; r >= s;)
                                            if (e > t[i = s + r >> 1][1]) s = i + 1;
                                            else {
                                                if (!(e < t[i][0])) return !0;
                                                r = i - 1
                                            } return !1
                                    }(e, r) ? e >= 131072 && e <= 196605 || e >= 196608 && e <= 262141 ? 2 : 1 : 0
                                }
                            }
                        },
                        5981: (e, t, i) => {
                                ...
                                _innerWrite(e = 0, t = !0) {
                                    ...
                                    for (; this._writeBuffer.length > this._bufferOffset;) {
                                        let e = this._writeBuffer[this._bufferOffset],
                                            s = this._action(e, t);
                                        if (s) {
                                            let e = e => Date.now() - i >= 12 ? setTimeout(() => this._innerWrite(0, e)) : this._innerWrite(i, e);
                                            return void s.catch(e => (queueMicrotask(() => {
                                                throw e
                                            }), Promise.resolve(!1))).then(e)
                                        }
                                        let r = this._callbacks[this._bufferOffset];
                        ...
                        5941: (e, t) => {
                            ...
                            let i = /^([\da-f])\/([\da-f])\/([\da-f])$|^([\da-f]{2})\/([\da-f]{2})\/([\da-f]{2})$|^([\da-f]{3})\/([\da-f]{3})\/([\da-f]{3})$|^([\da-f]{4})\/([\da-f]{4})\/([\da-f]{4})$/,
                                s = /^[\da-f]+$/;
                            ...
                            t.parseColor = function (e) {
                                ...
                                if (0 === t.indexOf("rgb:")) {
                                    ...
                                    let e = t.length / 3,
                                        i = [0, 0, 0];
                                    for (let s = 0; s < 3; ++s) {
                                        let r = parseInt(t.slice(e * s, e * s + e), 16);
                        ...
                        6351: (e, t, i) => {
                                ...
                                unhook(e, t = !0) {
                                    if (this._active.length) {
                                        ...
                                        if (this._stack.paused && (s = this._stack.loopPosition - 1, i = t, r = this._stack.fallThrough, this._stack.paused = !1), !r && !1 === i) {
                                            for (; s >= 0 && !0 !== (i = this._active[s].unhook(e)); s--)
                                                if (i instanceof Promise) return this._stack.paused = !0, this._stack.loopPosition = s, this._stack.fallThrough = !1, i;
                                            s--
                                        }
                                        for (; s >= 0; s--)
                                            if ((i = this._active[s].unhook(!1)) instanceof Promise) return this._stack.paused = !0, this._stack.loopPosition = s, this._stack.fallThrough = !0, i
                            ...
                            a.addParam(0), t.DcsHandler = class {
                                ...
                                unhook(e) {
                                    ...
                                    else if (e && (t = this._handler(this._data, this._params)) instanceof Promise) return t.then(e => (this._params = a, this._data = "", this._hitLimit = !1, e));
                            ...
                            class h extends s.Disposable {
                                ...
                                _identifier(e, t = [64, 126]) {
                                    ...
                                    if (e.prefix) {
                                        ...
                                        if ((i = e.prefix.charCodeAt(0)) && 60 > i || i > 63) throw Error("prefix must be in range 0x3c .. 0x3f")
                                    }
                                    if (e.intermediates) {
                                        ...
                                        for (let t = 0; t < e.intermediates.length; ++t) {
                                            let s = e.intermediates.charCodeAt(t);
                                            if (32 > s || s > 47) throw Error("intermediate must be in range 0x20 .. 0x2f");
                                            i <<= 8, i |= s
                                        }
                                    }
                                    if (1 !== e.final.length) throw Error("final must be a single byte");
                                    let s = e.final.charCodeAt(0);
                                    if (t[0] > s || s > t[1]) throw Error(`final must be in range ${t[0]} .. ${t[1]}`);
                                    return i <<= 8, i |= s
                                }
                                identToString(e) {
                                    let t = [];
                                ...
                                parse(e, t, i) {
                                    ...
                                    if (this._parseStack.state) {
                                        if (2 === this._parseStack.state) this._parseStack.state = 0, o = this._parseStack.chunkPos + 1;
                                            ...
                                            if (void 0 === i || 1 === this._parseStack.state) throw this._parseStack.state = 1, Error("improper continuation due to previous async handler, giving up parsing");
                                            let t = this._parseStack.handlers,
                                                n = this._parseStack.handlerPos - 1;
                                            switch (this._parseStack.state) {
                                                case 3:
                                                    if (!1 === i && n > -1) {
                                                        for (; n >= 0 && !0 !== (s = t[n](this._params)); n--)
                                                ...
                                                case 4:
                                                    ...
                                                    break;
                                                case 6:
                                                    if (r = e[this._parseStack.chunkPos], s = this._dcsParser.unhook(24 !== r && 26 !== r, i)) return s;
                                                    27 === r && (this._parseStack.transition |= 1), this._params.reset(), this._params.addParam(0), this._collect = 0;
                                                    break;
                                                case 5:
                                                    if (r = e[this._parseStack.chunkPos], s = this._oscParser.end(24 !== r && 26 !== r, i)) return s;
                                                    27 === r && (this._parseStack.transition |= 1), this._params.reset(), this._params.addParam(0), this._collect = 0
                                            }
                                    ...
                                    for (let i = o; i < t; ++i) {
                                        switch (r = e[i], (n = this._transitions.table[this.currentState << 8 | (r < 160 ? r : 160)]) >> 4) {
                                            case 2:
                                                for (let s = i + 1;; ++s)
                                                    if (s >= t || (r = e[s]) < 32 || r > 126 && r < 160 || ++s >= t || (r = e[s]) < 32 || r > 126 && r < 160 || ++s >= t || (r = e[s]) < 32 || r > 126 && r < 160 || ++s >= t || (r = e[s]) < 32 || r > 126 && r < 160) {
                                            ...
                                            case 1:
                                                ...
                                                break;
                                            case 7:
                                                let o = this._csiHandlers[this._collect << 8 | r],
                                                    a = o ? o.length - 1 : -1;
                                                for (; a >= 0 && !0 !== (s = o[a](this._params)); a--)
                                            ...
                                            case 9:
                                                ...
                                                break;
                                            case 10:
                                                let h = this._escHandlers[this._collect << 8 | r],
                                                    l = h ? h.length - 1 : -1;
                                                for (; l >= 0 && !0 !== (s = h[l]()); l--)
                                                    if (s instanceof Promise) return this._preserveStack(4, h, l, n, i), s;
                                            ...
                                            case 13:
                                                for (let s = i + 1;; ++s)
                                                    if (s >= t || 24 === (r = e[s]) || 26 === r || 27 === r || r > 127 && r < 160) {
                                                        this._dcsParser.put(e, i, s), i = s - 1;
                                                        break
                                                    } break;
                                            case 14:
                                                if (s = this._dcsParser.unhook(24 !== r && 26 !== r)) return this._preserveStack(6, [], 0, n, i), s;
                                            ...
                                            case 5:
                                                for (let s = i + 1;; s++)
                                                    if (s >= t || (r = e[s]) < 32 || r > 127 && r < 160) {
                                                        this._oscParser.put(e, i, s), i = s - 1;
                                                        break
                                                    } break;
                                            case 6:
                                                if (s = this._oscParser.end(24 !== r && 26 !== r)) return this._preserveStack(5, [], 0, n, i), s;
                                                27 === r && (n |= 1), this._params.reset(), this._params.addParam(0), this._collect = 0, this.precedingCodepoint = 0
                                        }
                        ...
                        6242: (e, t, i) => {
                            ...
                            t.OscParser = class {
                                        ...
                                        if (3 !== this._state) {
                                            if (1 === this._state && this._start(), this._active.length) {
                                                let i = !1,
                                                    ...
                                                    r = !1;
                                                if (this._stack.paused && (s = this._stack.loopPosition - 1, i = t, r = this._stack.fallThrough, this._stack.paused = !1), !r && !1 === i) {
                                                    for (; s >= 0 && !0 !== (i = this._active[s].end(e)); s--)
                                                        if (i instanceof Promise) return this._stack.paused = !0, this._stack.loopPosition = s, this._stack.fallThrough = !1, i;
                                                    s--
                                                }
                                                for (; s >= 0; s--)
                                                    if ((i = this._active[s].end(!1)) instanceof Promise) return this._stack.paused = !0, this._stack.loopPosition = s, this._stack.fallThrough = !0, i
                                ...
                                put(e, t, i) {
                                    ...
                                    let t = !1;
                                    if (this._hitLimit) t = !1;
                                    else if (e && (t = this._handler(this._data)) instanceof Promise) return t.then(e => (this._data = "", this._hitLimit = !1, e));
                        ...
                        8742: (e, t) => {
                            ...
                            class i {
                                ...
                                clone() {
                                    let e = new i(this.maxLength, this.maxSubParamsLength);
                                ...
                                addDigit(e) {
                                    ...
                                    let i = this._digitIsSub ? this._subParams : this.params,
                                        s = i[t - 1];
                                    i[t - 1] = ~s ? Math.min(10 * s + e, 2147483647) : e
                                }
                            }
                            t.Params = i
                        },
                                ...
                                _wrappedAddonDispose(e) {
                                    ...
                                    for (let i = 0; i < this._addons.length; i++)
                                        if (this._addons[i] === e) {
                                            t = i;
                                            break
                                        } if (-1 === t) throw Error("Could not dispose an addon that has not been loaded");
                        ...
                        744: function (e, t, i) {
                            ...
                            let l = t.BufferService = class extends o.Disposable {
                                ...
                                scroll(e, t = !1) {
                                    let i;
                                    let s = this.buffer;
                                    (i = this._cachedBlankLine) && i.length === this.cols && i.getFg(0) === e.fg && i.getBg(0) === e.bg || (i = s.getBlankLine(e, t), this._cachedBlankLine = i), i.isWrapped = t;
                                    let r = s.ybase + s.scrollTop,
                                        n = s.ybase + s.scrollBottom;
                                    if (0 === s.scrollTop) {
                                        let e = s.lines.isFull;
                            ...
                            t.BufferService = s([r(0, h.IOptionsService)], l)
                        },
                        7994: (e, t) => {
                            Object.defineProperty(t, "__esModule", {
                                value: !0
                        ...
                        1753: function (e, t, i) {
                            ...
                            let c = String.fromCharCode,
                                d = {
                                    ...
                                    SGR: e => {
                                        let t = 0 === e.action && 4 !== e.button ? "m" : "M";
                                ...
                                _ = t.CoreMouseService = class extends a.Disposable {
                                    constructor(e, t) {
                                        for (let i of (super(), this._bufferService = e, this._coreService = t, this._protocols = {}, this._encodings = {}, this._activeProtocol = "", this._activeEncoding = "", this._lastEvent = null, this._onProtocolChange = this.register(new o.EventEmitter), this.onProtocolChange = this._onProtocolChange.event, Object.keys(h))) this.addProtocol(i, h[i]);
                                    ...
                                    triggerMouseEvent(e) {
                                        if (e.col < 0 || e.col >= this._bufferService.cols || e.row < 0 || e.row >= this._bufferService.rows || 4 === e.button && 32 === e.action || 3 === e.button && 32 !== e.action || 4 !== e.button && (2 === e.action || 3 === e.action) || (e.col++, e.row++, 32 === e.action && this._lastEvent && this._equalEvents(this._lastEvent, e, "SGR_PIXELS" === this._activeEncoding)) || !this._protocols[this._activeProtocol].restrict(e)) return !1;
                            ...
                            t.CoreMouseService = s([r(0, n.IBufferService), r(1, n.ICoreService)], _)
                        },
                        6975: function (e, t, i) {
                            var s = this && this.__decorate || function (e, t, i, s) {
                                    var r, n = arguments.length,
                            ...
                            let n = i(1439),
                                ...
                                d = t.CoreService = class extends a.Disposable {
                                    constructor(e, t, i) {
                            ...
                            t.CoreService = s([r(0, h.IBufferService), r(1, h.ILogService), r(2, h.IOptionsService)], d)
                        },
                        9074: (e, t, i) => {
                            Object.defineProperty(t, "__esModule", {
                                value: !0
                            ...
                            class l extends n.Disposable {
                                ...
                                reset() {
                                    ...
                                    let o = 0,
                                        a = 0;
                                    for (let h of this._decorations.getKeyIterator(t)) a = (o = null !== (s = h.options.x) && void 0 !== s ? s : 0) + (null !== (r = h.options.width) && void 0 !== r ? r : 1), e >= o && e < a && (!i || (null !== (n = h.options.layer) && void 0 !== n ? n : "bottom") === i) && (yield h)
                                }
                                forEachDecorationAtCell(e, t, i, s) {
                                    this._decorations.forEachByKey(t, t => {
                                        var r, n, o;
                                        h = (a = null !== (r = t.options.x) && void 0 !== r ? r : 0) + (null !== (n = t.options.width) && void 0 !== n ? n : 1), e >= a && e < h && (!i || (null !== (o = t.options.layer) && void 0 !== o ? o : "bottom") === i) && s(t)
                                    })
                                }
                            }
                        ...
                        4348: (e, t, i) => {
                            ...
                            class n {
                                constructor(...e) {
                                    for (let [t, i] of (this._entries = new Map, e)) this.set(t, i)
                                }
                                set(e, t) {
                            ...
                            t.ServiceCollection = n, t.InstantiationService = class {
                                ...
                                createInstance(e, ...t) {
                                    let i = (0, r.getServiceDependencies)(e).sort((e, t) => e.index - t.index),
                                        s = [];
                                    for (let t of i) {
                                        let i = this._services.get(t.id);
                                        if (!i) throw Error(`[createInstance] ${e.name} depends on UNKNOWN service ${t.id}.`);
                                        s.push(i)
                                    }
                                    let n = i.length > 0 ? i[0].index : t.length;
                                    if (t.length !== n) throw Error(`[createInstance] First service dependency of ${e.name} at position ${n+1} conflicts with ${t.length} static arguments`);
                                    return new e(...[...t, ...s])
                                }
                            }
                        },
                        7866: function (e, t, i) {
                            ...
                            let n = i(844),
                                ...
                                h, l = t.LogService = class extends n.Disposable {
                                    get logLevel() {
                        ...
                        7302: (e, t, i) => {
                            ...
                            let o = ["normal", "bold", "100", "200", "300", "400", "500", "600", "700", "800", "900"];
                            class a extends r.Disposable {
                                constructor(e) {
                                    ...
                                    let i = Object.assign({}, t.DEFAULT_OPTIONS);
                                    for (let t in e)
                                        if (t in i) try {
                                            let s = e[t];
                                ...
                                _setupOptions() {
                                    let e = e => {
                                            if (!(e in t.DEFAULT_OPTIONS)) throw Error(`No option with key "${e}"`);
                                ...
                                _sanitizeAndValidateOption(e, i) {
                                    switch (e) {
                                        case "cursorStyle":
                                            var s;
                                            if (i || (i = t.DEFAULT_OPTIONS[e]), !("block" === (s = i) || "underline" === s || "bar" === s)) throw Error(`"${i}" is not a valid value for ${e}`);
                                            break;
                                        case "wordSeparator":
                                        ...
                                        case "lineHeight":
                                        case "tabStopWidth":
                                            if (i < 1) throw Error(`${e} cannot be less than 1, value: ${i}`);
                                            break;
                                        case "minimumContrastRatio":
                                            i = Math.max(1, Math.min(21, Math.round(10 * i) / 10));
                                            break;
                                        case "scrollback":
                                            if ((i = Math.min(i, 4294967295)) < 0) throw Error(`${e} cannot be less than 0, value: ${i}`);
                                            break;
                                        case "fastScrollSensitivity":
                                        case "scrollSensitivity":
                                            if (i <= 0) throw Error(`${e} cannot be less than or equal to 0, value: ${i}`);
                                            break;
                                        case "rows":
                                        case "cols":
                                            if (!i && 0 !== i) throw Error(`${e} must be numeric, value: ${i}`);
                                            break;
                                        case "windowsPty":
                                            i = null != i ? i : {}
                                    }
                            ...
                            let n = i(2585),
                                o = t.OscLinkService = class {
                                    ...
                                    registerLink(e) {
                                        ...
                                        let i = this._getEntryIdKey(e),
                                            s = this._entriesWithId.get(i);
                                        if (s) return this.addLineToLink(s.id, t.ybase + t.y), s.id;
                                        let r = t.addMarker(t.ybase + t.y),
                                            n = {
                                                id: this._nextId++,
                                                key: this._getEntryIdKey(e),
                                                data: e,
                                                lines: [r]
                                            };
                                        return r.onDispose(() => this._removeMarkerFromLink(n, r)), this._entriesWithId.set(n.key, n), this._dataByLinkId.set(n.id, n), n.id
                                    }
                                    addLineToLink(e, t) {
                                    ...
                                    _removeMarkerFromLink(e, t) {
                                        let i = e.lines.indexOf(t); - 1 !== i && (e.lines.splice(i, 1), 0 === e.lines.length && (void 0 !== e.data.id && this._entriesWithId.delete(e.key), this._dataByLinkId.delete(e.id)))
                                    }
                                };
                            t.OscLinkService = s([r(0, n.IBufferService)], o)
                        },
                        8343: (e, t) => {
                            Object.defineProperty(t, "__esModule", {
                                value: !0
                ...
                return (() => {
                    ...
                    class c extends r.Disposable {
                        constructor(e) {
                            super(), this._core = this.register(new t.Terminal(e)), this._addonManager = this.register(new n.AddonManager), this._publicOptions = Object.assign({}, this._core.options);
                            let i = e => this._core.options[e],
                                s = (e, t) => {
                        ...
                        _checkReadonlyOptions(e) {
                            if (l.includes(e)) throw Error(`Option "${e}" can only be set in the constructor`)
                        }
                        _checkProposedApi() {
                        ...
                        get buffer() {
                            return this._buffer || (this._buffer = this.register(new o.BufferNamespaceApi(this._core))), this._buffer
                        }
                        get markers() {
                        ...
                        _verifyIntegers(...e) {
                            for (let t of e)
                                if (t === 1 / 0 || isNaN(t) || t % 1 != 0) throw Error("This API only accepts integers")
                        }
                        _verifyPositiveIntegers(...e) {
                            for (let t of e)
                                if (t && (t === 1 / 0 || isNaN(t) || t % 1 != 0 || t < 0)) throw Error("This API only accepts positive integers")
                        }
                    }
                    s.Terminal = c
                })(), s
